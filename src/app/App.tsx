...
import { ClientIdVerification } from './components/kyc/ClientIdVerification';
...
import { GrowKYC } from './components/kyc/GrowKYC';
...
function getRequestedModule(): Module | null {
  ...
  const allowedModules: Module[] = ['grow_kyc', 'public_site'];
...
type UserRole = 'borrower' | 'lender' | 'investor' | 'admin' | 'lawyer' | 'receiver' | 'credit' | 'super_admin';

type Module = 'Grow MIP' | 'grow_accounting' | 'grow_lending' | 'grow_investments' | 'grow_receivership' | 'grow_kyc' | 'grow_crm' | 'grow_time' | 'grow_hq' | 'grow_payments' | 'grow_settlement' | 'grow_trust' | 'grow_esign' | 'ultimate_os' | 'qld_association' | 'atlas_practice' | 'public_site';
...
export default function App() {
  ...
  // IMFO MODULE: Investment Management & Fund Operations
    ...
    return (
      <div>
        ...
        <ModuleSwitcher
          ...
          onSwitchModule={(module) => handleModuleChange(module as Module)}
        />
        <IMFOPlatformModule onSwitchModule={(module) => handleModuleChange(module as Module)} />
      </div>
    );
  }
  ...
  const renderPageContent = () => {
    ...
    if (currentModule === 'grow_accounting' && currentPage === 'dashboard') {
    ...
    switch (currentPage) {
      ...
      case 'cases':
        ...
        return userRole === 'borrower' ? <CaseWorkspace /> : <CaseManagement 
          ...
          userRole={userRole}
          onCreateCase={() => setCurrentPage('case')}
        />;
      case 'case':
      ...
      case 'admin':
        return <AdminDashboard onNavigate={(page) => setCurrentPage(page as Page)} />;
      case 'admin_kyc':
        return <AdminKYCReview onNavigate={(page) => setCurrentPage(page as Page)} />;
      case 'admin_kyc_detail':
        return <KYCReviewDetail onBack={goBack} />;
      case 'ai_admin':
        return <AIAdminDashboard onNavigate={(page) => setCurrentPage(page as Page)} />;
      case 'email_center':
      ...
      case 'settings_organization':
        return <OrganizationSettings onBack={goBack} />;
      case 'settings_security':
        return <SecuritySettings onBack={goBack} />;
      case 'settings_notifications':
        return <NotificationSettings onBack={goBack} />;
      case 'user_management':
        return <UserManagement onBack={goBack} />;
      case 'access_control':
        return <AccessControl onBack={goBack} />;
      case 'module_settings':
        return <ModuleSettings onBack={goBack} />;
        ...
        <div className="px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between h-16">
            ...
            <div className="flex items-center gap-3">
              ...
              {/* Role Switcher - Improved (Dev Tool) */}
              <div className="hidden md:block">
                <select
                  value={userRole}
                  onChange={(e) => {
                  ...
                  className="pl-3 pr-8 py-2 border-2 border-indigo-200 rounded-lg text-sm font-medium text-indigo-700 bg-indigo-50 hover:bg-indigo-100 focus:outline-none focus:ring-2 focus:ring-indigo-500 transition-all cursor-pointer"
                >
                  <option value="borrower">ðŸ‘¤ Borrower</option>
                  ...
                  <option value="receiver">ðŸ“‹ Receiver</option>
            ...
            <nav className="px-4 py-4 space-y-1 max-h-[80vh] overflow-y-auto">
              ...
              <div className="space-y-2 pb-3 mb-3 border-b border-gray-200">
                ...
                <select
                  ...
                  className="w-full px-3 py-2 border-2 border-indigo-200 rounded-lg text-sm font-medium text-indigo-700 bg-indigo-50 focus:outline-none focus:ring-2 focus:ring-indigo-500"
                >
                  <option value="borrower">ðŸ‘¤ Borrower</option>
                  <option value="lender">ðŸ¦ Lender</option>
                  <option value="investor">ðŸ’¼ Investor</option>
...
function SettingsPlaceholder({ onNavigate }: { onNavigate: (page: Page) => void }) {
  return (
    <div className="space-y-6">
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        <div className="bg-white rounded-lg border p-6">
          ...
          <Button variant="outline" size="sm" onClick={() => onNavigate('settings_profile')}>Edit Profile</Button>
        </div>
        ...
        <div className="bg-white rounded-lg border p-6">
          ...
          <Button variant="outline" size="sm" onClick={() => onNavigate('settings_organization')}>Manage Organization</Button>
        </div>
        ...
        <div className="bg-white rounded-lg border p-6">
          ...
          <Button variant="outline" size="sm" onClick={() => onNavigate('settings_security')}>Security Settings</Button>
        </div>
        ...
        <div className="bg-white rounded-lg border p-6">
          ...
          <Button variant="outline" size="sm" onClick={() => onNavigate('settings_notifications')}>Notification Settings</Button>
        </div>
        ...
        <div className="bg-white rounded-lg border p-6">
          ...
          <Button variant="outline" size="sm" onClick={() => onNavigate('user_management')}>User Management</Button>
        </div>
        ...
        <div className="bg-white rounded-lg border p-6">
          ...
          <Button variant="outline" size="sm" onClick={() => onNavigate('access_control')}>Access Control</Button>
        </div>
        ...
        <div className="bg-white rounded-lg border p-6">
          ...
          <Button variant="outline" size="sm" onClick={() => onNavigate('module_settings')}>Module Settings</Button>
        </div>

        <div className="bg-white rounded-lg border p-6">
          <div className="flex items-center gap-3 mb-4">
            <BarChart3 className="w-5 h-5 text-indigo-600" />
            <h3 className="font-semibold">Integration Architecture</h3>
          </div>
          <p className="text-sm text-gray-600 mb-4">
            View how platform modules integrate together
          </p>
          <Button variant="outline" size="sm" onClick={() => onNavigate('integration_architecture')}>View Architecture</Button>
        </div>

        <div className="bg-white rounded-lg border p-6">
          <div className="flex items-center gap-3 mb-4">
            <BarChart3 className="w-5 h-5 text-indigo-600" />
            <h3 className="font-semibold">Integrations Hub</h3>
          </div>
          <p className="text-sm text-gray-600 mb-4">
            Manage and configure integrations
          </p>
          <Button variant="outline" size="sm" onClick={() => onNavigate('integrations_hub')}>Manage Integrations</Button>
        </div>
      </div>
    </div>
  );
