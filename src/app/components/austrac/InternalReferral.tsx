...
export function InternalReferral() {
          ...
          <Card className="lg:col-span-2 border-2 border-orange-300 shadow-lg">
            ...
            <CardContent className="p-6 space-y-6">
              ...
              <div>
                ...
                <select className="w-full px-4 py-3 border-2 border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-orange-500">
              ...
              <div className="pt-6 border-t space-y-3">
                <Button
                  disabled={!selectedSubject || !concernCategory}
                  className="w-full bg-red-600 hover:bg-red-700 text-white text-xl py-8 disabled:opacity-50 disabled:cursor-not-allowed"
                >
                  <Send className="w-6 h-6 mr-3" />
                  Submit Internal Referral & Create AUSTRAC Case
                </Button>
