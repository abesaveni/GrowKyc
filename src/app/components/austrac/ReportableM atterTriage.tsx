...
export function ReportableMatterTriage() {
  ...
  const caseData = {
    caseId: 'AUS-2026-002',
    subjectName: 'ABC Enterprises Pty Ltd',
    subjectType: 'Company',
        ...
        <div className="bg-gradient-to-r from-red-900 via-red-800 to-orange-900 rounded-lg p-6 text-white shadow-xl">
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-4">
              ...
              <div>
                <h1 className="text-3xl font-bold">Reportable Matter Triage</h1>
                <p className="text-white/90">Case ID: {caseData.caseId}</p>
              </div>
            </div>
          ...
          <Card className="border-2 border-blue-300 shadow-lg">
            ...
            <CardContent className="p-6 space-y-4">
              <div>
                ...
                <p className="font-mono font-bold text-blue-900 text-lg">{caseData.caseId}</p>
              </div>
              ...
              <div>
                ...
                <div className="flex items-center gap-2">
                  ...
                  <p className="font-bold text-gray-900">{caseData.subjectName}</p>
                </div>
              </div>
              ...
              <div>
                ...
                <p className="font-mono text-sm text-gray-900">{caseData.linkedClient}</p>
              </div>
              ...
              <div className="pt-3 border-t">
                ...
                <Badge className="bg-red-100 text-red-700 border-red-300 mb-2">
                  ...
                  {caseData.triggerSource}
                </Badge>
                <p className="text-xs text-gray-700">Triggered: {caseData.triggerDate}</p>
              </div>
              ...
              <div className="pt-3 border-t">
                ...
                <Badge className="bg-red-100 text-red-700 border-red-300 text-sm px-3 py-1">
                  {caseData.currentRiskBand.toUpperCase()}
                </Badge>
              </div>
              ...
              <div className="pt-3 border-t">
                ...
                <div className="flex items-center gap-2">
                  ...
                  <p className="text-sm text-amber-700 font-semibold">{caseData.serviceStatus}</p>
                </div>
              </div>
              ...
              <div className="pt-3 border-t">
                ...
                <div className="flex items-center gap-2">
                  ...
                  <p className="text-sm text-green-700 font-semibold">{caseData.monitoringStatus}</p>
                </div>
              </div>
            </CardContent>
          </Card>
