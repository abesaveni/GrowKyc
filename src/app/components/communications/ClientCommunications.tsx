      ...
      <Card>
        ...
        <CardContent>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
            <Card>
              <CardContent className="pt-6">
                ...
                <p className="text-3xl font-bold text-gray-900 mt-2">3,796</p>
                <p className="text-sm text-green-600 mt-1">â†‘ 24% from last month</p>
              </CardContent>
            </Card>
            <Card>
              <CardContent className="pt-6">
          ...
          <div className="bg-gray-50 rounded-lg p-8 text-center">
            ...
            <p className="text-gray-600 mb-2">Detailed analytics coming soon</p>
            <p className="text-sm text-gray-500">Track opens, clicks, bounces, and more</p>
          </div>
        </CardContent>
      </Card>
    </div>
