        ...
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-4">
            ...
            <div>
              ...
              <p className="text-sm text-gray-600">Complete control center for your KYC platform</p>
            </div>
          </div>
      ...
      <div className="p-6 max-w-7xl mx-auto">
        <Tabs value={activeTab} onValueChange={setActiveTab}>
          <TabsList className="grid grid-cols-7 w-full mb-6">
            <TabsTrigger value="kyc-config" className="flex items-center gap-2">
            ...
            <TabsTrigger value="risk-rules" className="flex items-center gap-2">
                ...
                <div className="grid md:grid-cols-2 gap-4">
                  <div className="bg-purple-50 rounded-lg p-4 border border-purple-200">
                    ...
                    <div className="flex items-center gap-2">
                      <Input type="number" defaultValue="50" className="border-2 border-purple-200" />
                  ...
                  <div className="bg-amber-50 rounded-lg p-4 border border-amber-200">
                    ...
                    <div className="flex items-center gap-2">
                      <Input type="number" defaultValue="10" className="border-2 border-amber-200" />
            ...
            <Card className="border-2 border-indigo-200">
              ...
              <CardContent className="space-y-4">
                ...
                <div className="bg-white rounded-lg p-4 border-2 border-indigo-300">
                  ...
                  <div className="flex items-center gap-4">
                    <Input type="number" defaultValue="5" className="w-24 border-2" />
              ...
              <CardContent className="space-y-4">
                <div className="grid md:grid-cols-2 gap-4">
                  <div className="bg-blue-50 rounded-lg p-4 border border-blue-200">
                    ...
                    <div className="flex items-center gap-2">
                      <Input type="number" defaultValue="7" className="w-24 border-2" />
                  ...
                  <div className="bg-blue-50 rounded-lg p-4 border border-blue-200">
                    ...
                    <div className="flex items-center gap-2">
                      <Input type="number" defaultValue="10" className="w-24 border-2" />
                      <span className="text-sm text-gray-600">years</span>
                    </div>
              ...
              <CardContent className="space-y-6">
                    ...
                    {[
                      ...
                      <div key={idx} className="flex items-center gap-4">
                        ...
                        <div className="flex-1 bg-gray-200 rounded-full h-2">
                          <div
                            className={`bg-${factor.color}-600 h-2 rounded-full`}
                ...
                <div className="grid md:grid-cols-3 gap-4">
                  <div className="bg-green-50 rounded-lg p-4 border-2 border-green-300">
                    ...
                    <div className="flex items-center gap-2">
                      <Input type="number" defaultValue="0" className="border-2" />
                      <span className="text-sm">-</span>
                      <Input type="number" defaultValue="30" className="border-2" />
                    </div>
                  </div>
                  <div className="bg-amber-50 rounded-lg p-4 border-2 border-amber-300">
                    <Label className="text-sm font-semibold mb-3 block text-amber-900">Medium Risk Threshold</Label>
                    <div className="flex items-center gap-2">
                      <Input type="number" defaultValue="31" className="border-2" />
                      <span className="text-sm">-</span>
                      <Input type="number" defaultValue="70" className="border-2" />
                    </div>
                  </div>
                  <div className="bg-red-50 rounded-lg p-4 border-2 border-red-300">
                    <Label className="text-sm font-semibold mb-3 block text-red-900">High Risk Threshold</Label>
                    <div className="flex items-center gap-2">
                      <Input type="number" defaultValue="71" className="border-2" />
                      <span className="text-sm">-</span>
                      <Input type="number" defaultValue="100" className="border-2" />
                    </div>
                  </div>
              ...
              <CardContent className="space-y-4">
                <div className="grid md:grid-cols-3 gap-4">
                  <div className="bg-green-50 rounded-lg p-4 border border-green-200">
                    ...
                    <div className="flex items-center gap-2">
                      <Input type="number" defaultValue="12" className="w-24 border-2" />
                  ...
                  <div className="bg-amber-50 rounded-lg p-4 border border-amber-200">
                    ...
                    <div className="flex items-center gap-2">
                      <Input type="number" defaultValue="6" className="w-24 border-2" />
                      <span className="text-sm text-gray-600">months</span>
                    </div>
                  </div>
                  <div className="bg-red-50 rounded-lg p-4 border border-red-200">
                    ...
                    <div className="flex items-center gap-2">
                      <Input type="number" defaultValue="3" className="w-24 border-2" />
                      <span className="text-sm text-gray-600">months</span>
                    </div>
                  </div>
                </div>
              ...
              <CardContent className="space-y-6">
                <div className="grid md:grid-cols-2 gap-6">
                  ...
                  <div className="bg-purple-50 rounded-lg p-4 border border-purple-200">
                    ...
                    <div className="flex items-center gap-3">
                      <Input type="color" defaultValue="#13B5EA" className="w-20 h-12 border-2" />
                      <Input defaultValue="#13B5EA" className="border-2" />
                    </div>
            ...
            <Card className="border-2 border-indigo-200">
              ...
              <CardContent className="space-y-4">
                <div className="bg-indigo-50 rounded-lg p-4 border border-indigo-200">
                  ...
                  <select className="w-full px-4 py-2 border-2 rounded-lg">
              ...
              <CardContent className="space-y-4">
                <div className="grid md:grid-cols-2 gap-4">
                  ...
                  <div className="flex items-center justify-between p-4 bg-red-50 rounded-lg border border-red-200">
                    ...
                    <div className="flex items-center gap-2">
                      <Input type="number" defaultValue="30" className="w-20 border-2" />
