...
export function IntegrationsSettings() {
  ...
  const categories = [
    ...
    { id: 'Communications', label: 'Communications', count: integrations.filter(i => i.category === 'Communications').length },
    ...
    { id: 'Identity & Credit', label: 'Identity & Credit', count: integrations.filter(i => i.category === 'Identity & Credit').length },
    { id: 'Property & Legal', label: 'Property & Legal', count: integrations.filter(i => i.category === 'Property & Legal').length },
    { id: 'AML & Compliance', label: 'AML & Compliance', count: integrations.filter(i => i.category === 'AML & Compliance').length },
    { id: 'Government', label: 'Government', count: integrations.filter(i => i.category === 'Government').length },
    { id: 'Documents', label: 'Documents', count: integrations.filter(i => i.category === 'Documents').length },
    { id: 'CRM', label: 'CRM', count: integrations.filter(i => i.category === 'CRM').length },
    { id: 'Practice Management', label: 'Practice Management', count: integrations.filter(i => i.category === 'Practice Management').length }
  ];
