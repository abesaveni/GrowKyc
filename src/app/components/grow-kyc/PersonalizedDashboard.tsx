      ...
      <div className="bg-gradient-to-r from-[#13B5EA] to-[#0E7C9E] rounded-2xl p-12 text-white shadow-lg mt-8">
        ...
        <div className="grid grid-cols-4 gap-6 mt-8">
          <div 
            ...
            className="bg-white/10 backdrop-blur-sm rounded-xl p-6 border border-white/20 cursor-pointer hover:bg-white/20 hover:scale-105 transition-all duration-300"
          >
            <div className="text-3xl font-bold mb-1">23</div>
            <div className="text-sm text-white/90">Pending Reviews</div>
            <div className="text-xs text-white/70 mt-2">Click to view requirements</div>
          </div>
          <div 
            onClick={onNavigateToRequirements}
            className="bg-white/10 backdrop-blur-sm rounded-xl p-6 border border-white/20 cursor-pointer hover:bg-white/20 hover:scale-105 transition-all duration-300"
          >
            ...
            <div className="text-sm text-white/90">High Risk Alerts</div>
            <div className="text-xs text-white/70 mt-2">Click to view requirements</div>
          </div>
          <div 
            onClick={onNavigateToRequirements}
          ...
          >
            ...
            <div className="text-sm text-white/90">Active Clients</div>
            <div className="text-xs text-white/70 mt-2">Click to view requirements</div>
          </div>
          <div 
            onClick={onNavigateToRequirements}
          ...
          >
            ...
            <div className="text-sm text-white/90">Compliance Rate</div>
            <div className="text-xs text-white/70 mt-2">Click to view requirements</div>
          </div>
        </div>
      </div>
      ...
      <div className="grid grid-cols-4 gap-8">
        <Card className="border-l-4 border-l-red-500 shadow-sm hover:shadow-md transition-shadow">
          <CardHeader className="pb-4">
            <div className="flex items-center justify-between">
              <CardTitle className="text-sm font-medium text-gray-600">Urgent Actions</CardTitle>
          ...
          <CardContent className="pb-6">
            ...
            <Button variant="link" className="text-sm p-0 h-auto mt-4 text-[#13B5EA]" onClick={onNavigateToCases}>View all →</Button>
          </CardContent>
        </Card>
        ...
        <Card className="border-l-4 border-l-amber-500 shadow-sm hover:shadow-md transition-shadow">
          ...
          <CardContent className="pb-6">
            ...
            <p className="text-sm text-gray-600 mt-2">12 due this week</p>
            <Button variant="link" className="text-sm p-0 h-auto mt-4 text-[#13B5EA]" onClick={onNavigateToCases}>Review queue →</Button>
          </CardContent>
        </Card>
        ...
        <Card className="border-l-4 border-l-green-500 shadow-sm hover:shadow-md transition-shadow">
          ...
          <CardContent className="pb-6">
            ...
            <Button variant="link" className="text-sm p-0 h-auto mt-4 text-[#13B5EA]">View details →</Button>
          </CardContent>
        </Card>
        ...
        <Card className="border-l-4 border-l-blue-500 shadow-sm hover:shadow-md transition-shadow">
          ...
          <CardContent className="pb-6">
            ...
            <p className="text-sm text-gray-600 mt-2">Team avg score</p>
            <Button variant="link" className="text-sm p-0 h-auto mt-4 text-[#13B5EA]">Team metrics →</Button>
          </CardContent>
        </Card>
      </div>
            ...
            {[
              ...
              <div
                ...
                className={`p-4 bg-white rounded-lg border-2 ${
                  client.urgency === 'critical' ? 'border-red-300' :
    ...
    <div className="space-y-6">
      ...
      <div className="bg-gradient-to-r from-cyan-600 to-blue-600 rounded-xl p-8 text-white">
        <div className="flex items-center gap-4 mb-4">
          <div className="text-5xl">{userAvatar}</div>
          <div>
            <h1 className="text-3xl font-bold">Your Investigation Workspace</h1>
            <p className="text-cyan-100 text-lg">{userName} • {userTitle}</p>
          </div>
        </div>
        <div className="grid grid-cols-4 gap-4 mt-6">
          <div className="bg-white/10 backdrop-blur-sm rounded-lg p-4">
            <div className="text-2xl font-bold">14</div>
            <div className="text-sm text-cyan-100">Cases Assigned</div>
          </div>
          <div className="bg-white/10 backdrop-blur-sm rounded-lg p-4">
            <div className="text-2xl font-bold">6</div>
            <div className="text-sm text-cyan-100">High Priority</div>
          </div>
          <div className="bg-white/10 backdrop-blur-sm rounded-lg p-4">
            <div className="text-2xl font-bold">23</div>
            <div className="text-sm text-cyan-100">Alerts Today</div>
          </div>
          <div className="bg-white/10 backdrop-blur-sm rounded-lg p-4">
            <div className="text-2xl font-bold">87%</div>
            <div className="text-sm text-cyan-100">Resolution Rate</div>
          </div>
        </div>
      </div>
          ...
          <div className="space-y-2">
            {[
              ...
              <div key={index} className={`flex items-center justify-between p-4 rounded-lg border-2 ${
                alert.risk === 'Critical' ? 'bg-red-50 border-red-300' : 
