...
export function Tier5EnterpriseOS({ onBack }: Tier5EnterpriseOSProps) {
  ...
  if (currentModule === 'capacity-planning') {
    return <CapacityPlanningBot onBack={() => setCurrentModule('hub')} />;
  }
        ...
        <div className="max-w-7xl mx-auto px-8 py-6">
          ...
          <div className="flex items-center gap-4 mb-6">
            ...
            <div>
              ...
              <h1 className="text-5xl font-bold text-gray-900">Autonomous Platform Layer</h1>
              <p className="text-gray-600 text-xl">Not a compliance tool. An enterprise operating system.</p>
            </div>
          </div>
          ...
          <div className="bg-gradient-to-r from-purple-50 via-indigo-50 to-blue-50 border-4 border-purple-400 rounded-xl p-8 shadow-2xl">
            ...
            <div className="grid md:grid-cols-3 gap-6 mb-6">
              <div className="bg-white p-6 rounded-xl border-2 border-purple-300 shadow-lg">
                ...
                <p className="font-bold text-gray-900 text-lg mb-2">AI-Driven Orchestration</p>
                <p className="text-sm text-gray-700">Autonomous workflow execution, predictive routing, AI copilot support—work happens automatically</p>
              </div>
              <div className="bg-white p-6 rounded-xl border-2 border-blue-300 shadow-lg">
                <Wallet className="w-12 h-12 text-blue-600 mb-3" />
                <p className="font-bold text-gray-900 text-lg mb-2">Reusable Intelligence</p>
                <p className="text-sm text-gray-700">One-time verification, perpetual wallet—identity & entity data reused across all services forever</p>
              </div>
              <div className="bg-white p-6 rounded-xl border-2 border-green-300 shadow-lg">
                ...
                <p className="font-bold text-gray-900 text-lg mb-2">Multi-Firm Enterprise</p>
                <p className="text-sm text-gray-700">Accounting firms, lenders, brokers, investor groups—one platform, isolated data, central oversight</p>
              </div>
            </div>
            ...
            <div className="grid md:grid-cols-3 gap-6">
              <div className="bg-white p-6 rounded-xl border-2 border-amber-300 shadow-lg">
                ...
                <p className="font-bold text-gray-900 text-lg mb-2">Predictive Capacity</p>
                <p className="text-sm text-gray-700">Forecast staffing needs, bottlenecks, overload risk—practice management intelligence</p>
              </div>
              <div className="bg-white p-6 rounded-xl border-2 border-indigo-300 shadow-lg">
                ...
                <p className="font-bold text-gray-900 text-lg mb-2">Investor & Lender Views</p>
                <p className="text-sm text-gray-700">Deal intelligence, borrower profiling, security tracking—extends beyond accounting to private capital</p>
              </div>
              <div className="bg-white p-6 rounded-xl border-2 border-pink-300 shadow-lg">
                <Brain className="w-12 h-12 text-pink-600 mb-3" />
                <p className="font-bold text-gray-900 text-lg mb-2">Explainable AI Copilot</p>
                <p className="text-sm text-gray-700">Draft memos, summarize findings, explain decisions—AI beside every reviewer</p>
              </div>
            </div>
            ...
            <div className="mt-6 p-6 bg-gradient-to-r from-purple-100 to-blue-100 rounded-xl border-2 border-purple-400">
              <p className="text-center text-lg text-gray-900">
                ...
                <span className="text-gray-700">Tier 1 = Compliance</span> •{' '}
                <span className="text-gray-700">Tier 2 = Understanding</span> •{' '}
                <span className="text-gray-700">Tier 3 = Decisions</span> •{' '}
                <span className="text-gray-700">Tier 4 = Profit</span> •{' '}
        ...
        <div className="grid md:grid-cols-3 gap-6 mb-8">
          ...
          >
            <CardContent className="p-6">
              ...
              <h2 className="text-2xl font-bold text-gray-900 mb-2">AI Compliance Analyst Copilot</h2>
              ...
              <div className="grid grid-cols-2 gap-2 mb-3">
                <div className="bg-white p-2 rounded border-2 border-purple-300 text-center">
          ...
          >
            <CardContent className="p-6">
              ...
              <h2 className="text-2xl font-bold text-gray-900 mb-2">Autonomous Workflow Orchestrator</h2>
              <p className="text-gray-700 mb-3 text-sm">
          ...
          >
            <CardContent className="p-6">
              ...
              <h2 className="text-2xl font-bold text-gray-900 mb-2">Predictive Capacity Planning</h2>
              <p className="text-gray-700 mb-3 text-sm">
              ...
              <div className="grid grid-cols-2 gap-2 mb-3">
                <div className="bg-white p-2 rounded border-2 border-green-300 text-center">
                  <p className="text-xs text-green-700">Utilization</p>
                  <p className="text-xl font-bold text-green-600">87%</p>
                </div>
                <div className="bg-white p-2 rounded border-2 border-red-300 text-center">
          ...
          >
            <CardContent className="p-6">
              ...
              <h2 className="text-2xl font-bold text-gray-900 mb-2">Investor & Lender Intelligence</h2>
              <p className="text-gray-700 mb-3 text-sm">
              ...
              <div className="grid grid-cols-2 gap-2 mb-3">
                <div className="bg-white p-2 rounded border-2 border-amber-300 text-center">
          ...
          >
            <CardContent className="p-6">
              ...
              <h2 className="text-2xl font-bold text-gray-900 mb-2">Reusable Identity Wallet</h2>
              <p className="text-gray-700 mb-3 text-sm">
              ...
              <div className="grid grid-cols-2 gap-2 mb-3">
                <div className="bg-white p-2 rounded border-2 border-indigo-300 text-center">
          ...
          >
            <CardContent className="p-6">
              ...
              <h2 className="text-2xl font-bold text-gray-900 mb-2">Enterprise Multi-Firm Control</h2>
              <p className="text-gray-700 mb-3 text-sm">
              ...
              <div className="grid grid-cols-2 gap-2 mb-3">
                <div className="bg-white p-2 rounded border-2 border-pink-300 text-center">
          ...
          <CardContent className="p-8">
            <div className="space-y-4 mb-6">
              {[
                ...
                return (
                  <div key={idx} className="flex items-center gap-4 p-4 bg-white rounded-lg border-2 border-purple-200 shadow-sm">
                    ...
                    <div className="flex-1">
                      <p className="font-bold text-gray-900">{idx + 1}. {step.label}</p>
                    </div>
                    {idx < 9 && <ArrowRight className="w-5 h-5 text-gray-400" />}
                  </div>
                );
              })}
            </div>
            ...
            <div className="bg-white rounded-xl border-2 border-purple-300 p-6 shadow-lg">
              <h4 className="font-bold text-gray-900 text-xl mb-4">What Tier 5 Achieves:</h4>
          ...
          <CardContent className="p-6">
            ...
            <div className="grid md:grid-cols-3 gap-6">
              <div className="text-center">
                ...
                <h4 className="font-bold text-gray-900 mb-2">Autonomous Workflows</h4>
              ...
              <div className="text-center">
                ...
                <h4 className="font-bold text-gray-900 mb-2">Perpetual Wallets</h4>
                <p className="text-sm text-gray-700">
              ...
              <div className="text-center">
                ...
                <h4 className="font-bold text-gray-900 mb-2">Multi-Firm Enterprise</h4>
                <p className="text-sm text-gray-700">
...
// Simplified component stubs for each module
function AICopilotBot({ onBack }: { onBack: () => void }) {
  return (
    <div className="min-h-screen bg-gray-50">
      <div className="bg-white border-b">
        <div className="max-w-7xl mx-auto px-8 py-6">
          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              <Badge className="bg-purple-600 text-white mb-2">AI COPILOT</Badge>
              <h1 className="text-3xl font-bold text-gray-900">AI Compliance Analyst Copilot</h1>
              <p className="text-gray-600">Explainable AI beside every reviewer—draft memos, summarize, explain decisions</p>
            </div>
          </div>
        </div>
      </div>
      <div className="max-w-7xl mx-auto px-8 py-8">
        <Card className="border-2 border-purple-400">
          <CardContent className="p-8 text-center">
            <Bot className="w-20 h-20 text-purple-600 mx-auto mb-4" />
            <h2 className="text-2xl font-bold text-gray-900 mb-2">AI Copilot Workspace</h2>
            <p className="text-gray-600 mb-6">247 cases supported today • 89 memos drafted automatically</p>
            <div className="grid md:grid-cols-3 gap-4 max-w-2xl mx-auto">
              <div className="p-4 bg-purple-50 rounded-lg border border-purple-200">
                <p className="text-xs text-purple-700">Task Type</p>
                <p className="font-bold text-purple-900">Case Summary</p>
              </div>
              <div className="p-4 bg-purple-50 rounded-lg border border-purple-200">
                <p className="text-xs text-purple-700">Confidence</p>
                <p className="font-bold text-green-900">High (94%)</p>
              </div>
              <div className="p-4 bg-purple-50 rounded-lg border border-purple-200">
                <p className="text-xs text-purple-700">Status</p>
                <p className="font-bold text-gray-900">Ready for Review</p>
              </div>
            </div>
          </CardContent>
        </Card>
        ...
        <div className="max-w-7xl mx-auto px-8 py-6">
          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <h1 className="text-3xl font-bold text-gray-900">Autonomous Workflow Orchestrator</h1>
              <p className="text-gray-600">Work routes automatically—no manual assignment needed</p>
            </div>
          </div>
        </div>
      </div>
...
function CapacityPlanningBot({ onBack }: { onBack: () => void }) {
  return (
    <div className="min-h-screen bg-gray-50">
      <div className="bg-white border-b">
        <div className="max-w-7xl mx-auto px-8 py-6">
          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              <Badge className="bg-green-600 text-white mb-2">PREDICTIVE</Badge>
              <h1 className="text-3xl font-bold text-gray-900">Predictive Capacity & Workforce Planning</h1>
              <p className="text-gray-600">Forecast staffing needs, bottlenecks, and overload risk</p>
            </div>
          </div>
        </div>
      </div>
        ...
        <div className="max-w-7xl mx-auto px-8 py-6">
          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <h1 className="text-3xl font-bold text-gray-900">Investor & Lender Intelligence</h1>
              <p className="text-gray-600">Deal intelligence, borrower profiling, portfolio exposure</p>
            </div>
          </div>
        </div>
      </div>
        ...
        <div className="max-w-7xl mx-auto px-8 py-6">
          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <h1 className="text-3xl font-bold text-gray-900">Reusable Identity & Entity Wallet</h1>
              <p className="text-gray-600">One-time verification, perpetual use—12,847 active wallets</p>
            </div>
          </div>
        </div>
      </div>
        ...
        <div className="max-w-7xl mx-auto px-8 py-6">
          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <h1 className="text-3xl font-bold text-gray-900">Enterprise Multi-Firm Control</h1>
              <p className="text-gray-600">23 firms • 847 users • Isolated data with central oversight</p>
            </div>
          </div>
        </div>
      </div>
