...
export const renderFundAdmin = () => (
  <div className="space-y-6">
    <div className="flex items-center justify-between">
      <h2 className="text-2xl font-bold text-gray-900">Fund Administration</h2>
    ...
    <div className="grid grid-cols-1 md:grid-cols-5 gap-4">
      <Card className="border-l-4 border-purple-600">
        <CardContent className="p-6">
          ...
          <p className="text-xs text-gray-500 mt-1">18 investors</p>
        </CardContent>
      </Card>
      <Card className="border-l-4 border-blue-600">
        <CardContent className="p-6">
          ...
          <p className="text-xs text-blue-600 mt-1">60.8% call rate</p>
        </CardContent>
      </Card>
      <Card className="border-l-4 border-green-600">
        <CardContent className="p-6">
          <p className="text-sm text-gray-600 mb-1">Paid Capital</p>
          <p className="text-2xl font-bold text-gray-900">$14.8M</p>
          <p className="text-xs text-green-600 mt-1">97.4% collected</p>
        </CardContent>
      </Card>
      <Card className="border-l-4 border-amber-600">
        <CardContent className="p-6">
          <p className="text-sm text-gray-600 mb-1">Outstanding Calls</p>
          <p className="text-2xl font-bold text-amber-900">$400K</p>
          <p className="text-xs text-amber-600 mt-1">2 overdue</p>
        </CardContent>
      </Card>
      <Card className="border-l-4 border-indigo-600">
        <CardContent className="p-6">
          <p className="text-sm text-gray-600 mb-1">Fund NAV</p>
          <p className="text-2xl font-bold text-gray-900">$15.8M</p>
          <p className="text-xs text-green-600 mt-1">+$600K gain</p>
        </CardContent>
      </Card>
    </div>
          ...
          <table className="w-full">
            <thead className="bg-gray-50">
              <tr>
                ...
                <th className="px-4 py-3 text-right text-xs font-semibold text-gray-600 uppercase">Commitment</th>
                <th className="px-4 py-3 text-right text-xs font-semibold text-gray-600 uppercase">Called</th>
            ...
            <tbody className="divide-y divide-gray-200">
              {[
                ...
                <tr key={idx} className="hover:bg-gray-50">
                  <td className="px-4 py-3 text-sm font-semibold text-gray-900">{investor.name}</td>
                  ...
                  <td className="px-4 py-3 text-sm text-right text-gray-900">${(investor.commitment / 1000000).toFixed(1)}M</td>
                  <td className="px-4 py-3 text-sm text-right text-blue-900">${(investor.called / 1000000).toFixed(1)}M</td>
          ...
          <div className="space-y-3">
            {[
              ...
              <div key={idx} className={`p-4 border-l-4 rounded-lg ${
                call.status === 'overdue' ? 'bg-red-50 border-red-500' : 'bg-amber-50 border-amber-500'
              }`}>
                <div className="flex items-center justify-between mb-2">
                  <span className="font-mono font-bold text-gray-900">{call.id}</span>
                  <span className={`px-2 py-1 text-xs font-semibold rounded ${
                ...
                <div className="flex items-center justify-between text-sm">
                  <span className="text-gray-700">Amount: ${call.amount.toLocaleString()}</span>
                  <span className="text-gray-600">Due: {call.due}</span>
                </div>
                <p className="text-xs text-gray-600 mt-2">{call.investors} investors</p>
              </div>
            ))}
          </div>
        </CardContent>
        ...
        <CardContent>
          <div className="space-y-3">
            {[
              ...
              <div key={idx} className="p-4 border rounded-lg bg-green-50 border-green-300">
                <div className="flex items-center justify-between mb-2">
                  <span className="font-mono font-bold text-gray-900">{dist.id}</span>
                  <span className="px-2 py-1 bg-green-600 text-white text-xs font-semibold rounded">
                    {dist.type}
                  </span>
                </div>
                <div className="flex items-center justify-between text-sm">
                  <span className="text-gray-700">Amount: ${dist.amount.toLocaleString()}</span>
                  <span className="text-gray-600">{dist.date}</span>
                </div>
                <p className="text-xs text-gray-600 mt-2">{dist.investors} recipients</p>
              </div>
            ))}
          </div>
        </CardContent>
    ...
    <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
      ...
      <Card className="border-l-4 border-purple-600">
        <CardContent className="p-6">
          ...
          <p className="text-xl font-bold text-gray-900">2 hrs ago</p>
          <p className="text-xs text-green-600 mt-1">All accounts</p>
        </CardContent>
      </Card>
    </div>
            ...
            <div key={idx} className="flex items-center justify-between p-4 border rounded-lg hover:bg-gray-50">
              <div className="flex-1">
                <div className="flex items-center gap-3 mb-2">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-gray-600">{account.bsb} {account.account}</p>
                  </div>
                </div>
              </div>
              <div className="text-right">
                ...
                <div className="flex items-center gap-2 mt-1">
                  <span className="px-2 py-1 bg-green-100 text-green-700 text-xs font-semibold rounded">{account.status.toUpperCase()}</span>
          ...
          <table className="w-full">
            <thead className="bg-gray-50">
              <tr>
                ...
                <th className="px-4 py-3 text-center text-xs font-semibold text-gray-600 uppercase">Suggested Match</th>
                <th className="px-4 py-3 text-right text-xs font-semibold text-gray-600 uppercase">Actions</th>
              </tr>
            </thead>
            <tbody className="divide-y divide-gray-200">
                  ...
                  <td className="px-4 py-3 text-center">
                    {txn.confidence > 0 ? (
                      <div className="flex items-center justify-center gap-2">
                        <span className="font-mono text-sm font-semibold text-blue-700">{txn.match}</span>
                        <span className="px-2 py-1 bg-green-100 text-green-700 text-xs font-semibold rounded">{txn.confidence}%</span>
                      </div>
                    ) : (
                      <span className="px-2 py-1 bg-amber-100 text-amber-700 text-xs font-semibold rounded">REVIEW REQUIRED</span>
                    )}
                  </td>
                  <td className="px-4 py-3 text-right">
    ...
    <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
      <Card className="border-l-4 border-amber-600">
        <CardContent className="p-6">
          ...
          <p className="text-xs text-gray-500 mt-1">Total: $425K</p>
        </CardContent>
      </Card>
      <Card className="border-l-4 border-blue-600">
        <CardContent className="p-6">
          ...
          <p className="text-xs text-blue-600 mt-1">Total: $1.2M</p>
        </CardContent>
      </Card>
      <Card className="border-l-4 border-green-600">
        <CardContent className="p-6">
          ...
          <p className="text-xs text-gray-500 mt-1">Total: $8.5M</p>
        </CardContent>
      </Card>
      <Card className="border-l-4 border-red-600">
        <CardContent className="p-6">
          <p className="text-sm text-gray-600 mb-1">Blocked Payments</p>
      ...
      <CardContent>
        <div className="space-y-3">
          {[
            ...
            <div key={idx} className={`p-4 border-l-4 rounded-lg ${
              batch.status === 'partial_approval' ? 'bg-blue-50 border-blue-500' : 'bg-amber-50 border-amber-500'
            }`}>
              <div className="flex items-start justify-between">
                <div className="flex-1">
                  <div className="flex items-center gap-3 mb-2">
                    <span className="font-mono font-bold text-gray-900">{batch.id}</span>
                  ...
                  <div className="grid grid-cols-3 gap-4 text-sm mb-3">
                    <div>
                      ...
                      <p className="font-bold text-gray-900">${batch.amount.toLocaleString()}</p>
                    </div>
                    <div>
                      <p className="text-gray-600">Payments</p>
                      <p className="font-bold text-gray-900">{batch.payments} transactions</p>
                    </div>
                    <div>
                      <p className="text-gray-600">Created</p>
                      <p className="font-bold text-gray-900">{batch.created}</p>
                    </div>
                  </div>
                  <div className="flex items-center gap-4 text-sm">
                    <div className="flex items-center gap-2">
                      <UserCheck className="w-4 h-4 text-gray-500" />
                      <span className="text-gray-600">Approver 1:</span>
                      <span className={`font-semibold ${batch.approver1 === 'Pending' ? 'text-amber-700' : 'text-green-700'}`}>
                        {batch.approver1}
                      </span>
                    </div>
                    <div className="flex items-center gap-2">
                      <UserCheck className="w-4 h-4 text-gray-500" />
                      <span className="text-gray-600">Approver 2:</span>
                      <span className={`font-semibold ${batch.approver2 === 'Pending' || batch.approver2 === 'Required' ? 'text-amber-700' : 'text-green-700'}`}>
                        {batch.approver2}
                      </span>
                    </div>
                  </div>
          ...
          <table className="w-full">
            ...
            <tbody className="divide-y divide-gray-200">
              {[
                ...
                <tr key={idx} className="hover:bg-gray-50">
                  <td className="px-4 py-3 text-sm font-mono font-semibold text-gray-900">{batch.id}</td>
                  <td className="px-4 py-3 text-sm text-gray-900">{batch.type}</td>
                  <td className="px-4 py-3 text-sm font-bold text-right text-gray-900">${batch.amount.toLocaleString()}</td>
                  <td className="px-4 py-3 text-sm text-center text-gray-900">{batch.payments}</td>
                  <td className="px-4 py-3 text-center">
...
export const renderCompliance = () => (
  <div className="space-y-6">
    ...
    <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
      <Card className="border-l-4 border-green-600">
        <CardContent className="p-6">
          <p className="text-sm text-gray-600 mb-1">Trust Compliance</p>
          <div className="flex items-center gap-2">
            <CheckCircle className="w-6 h-6 text-green-600" />
            <p className="text-2xl font-bold text-green-900">PASS</p>
          </div>
          <p className="text-xs text-gray-500 mt-1">All checks passed</p>
        </CardContent>
      </Card>
      <Card className="border-l-4 border-green-600">
        <CardContent className="p-6">
          <p className="text-sm text-gray-600 mb-1">AML Status</p>
          <div className="flex items-center gap-2">
            <CheckCircle className="w-6 h-6 text-green-600" />
            <p className="text-2xl font-bold text-green-900">CURRENT</p>
          </div>
          <p className="text-xs text-gray-500 mt-1">16/18 reviewed</p>
        </CardContent>
      </Card>
      <Card className="border-l-4 border-amber-600">
        <CardContent className="p-6">
          <p className="text-sm text-gray-600 mb-1">Period Lock</p>
          <div className="flex items-center gap-2">
            <Lock className="w-6 h-6 text-amber-600" />
            <p className="text-2xl font-bold text-amber-900">FEB 2026</p>
          </div>
          <p className="text-xs text-amber-600 mt-1">Lock pending</p>
        </CardContent>
      </Card>
      <Card className="border-l-4 border-blue-600">
        <CardContent className="p-6">
          ...
          <p className="text-xs text-gray-500 mt-1">Complete logging</p>
        </CardContent>
      </Card>
    </div>
        ...
        <div className="space-y-3">
          <div className="p-4 bg-green-50 border-2 border-green-300 rounded-lg">
            <div className="flex items-center gap-3">
              <CheckCircle className="w-6 h-6 text-green-600" />
              <div className="flex-1">
                <p className="font-semibold text-green-900">No Active Breaches</p>
                <p className="text-sm text-green-700">All compliance checks passed. System operating normally.</p>
              </div>
            </div>
          </div>
          ...
          <div className="border-t pt-4 mt-4">
            <p className="text-sm font-semibold text-gray-700 mb-3">Recent Alerts (Resolved)</p>
            {[
              ...
              <div key={idx} className="p-3 bg-gray-50 border rounded-lg mb-2">
                <div className="flex items-start justify-between">
                  <div className="flex-1">
                  ...
                  <span className="px-2 py-1 bg-gray-200 text-gray-700 text-xs font-semibold rounded">RESOLVED</span>
                </div>
              </div>
            ))}
          </div>
          ...
          <div className="space-y-3">
            {[
              ...
              <div key={idx} className={`p-3 border-l-4 rounded-lg ${
                period.status === 'locked' ? 'bg-gray-50 border-gray-400' : 'bg-blue-50 border-blue-500'
              }`}>
                <div className="flex items-center justify-between">
                  <div className="flex-1">
                    <div className="flex items-center gap-2 mb-1">
                      <p className="font-semibold text-gray-900">{period.period}</p>
                      {period.status === 'locked' && <Lock className="w-4 h-4 text-gray-600" />}
                    </div>
                    <p className="text-xs text-gray-600">{period.transactions} transactions</p>
          ...
          <table className="w-full">
            ...
            <tbody className="divide-y divide-gray-200">
              {[
                ...
                <tr key={idx} className="hover:bg-gray-50">
                  <td className="px-4 py-3 text-xs font-mono text-gray-900">{event.time}</td>
                  <td className="px-4 py-3 text-sm text-gray-900">{event.user}</td>
                  <td className="px-4 py-3 text-sm text-gray-900">{event.action}</td>
                  <td className="px-4 py-3 text-sm font-mono text-gray-900">{event.entity}</td>
                  <td className="px-4 py-3 text-center">
                    <span className="px-2 py-1 bg-green-100 text-green-700 text-xs font-semibold rounded">
