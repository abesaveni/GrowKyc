...
RISK_THRESHOLDS = {"LOW": (0, 39), "MEDIUM": (40, 79), "HIGH": (80, 100)}
...
RISK_FACTORS = {
    "geography": {
        ...
        "weights": {"high": 40, "medium": 20, "low": 0},
    },
    "pep": {
        "description": "Politically Exposed Person matching",
        "weights": {"is_pep": 40, "not_pep": 0},
    },
    "sanctions": {
        "description": "Sanctions list matching",
        "weights": {"is_sanctioned": 100, "not_sanctioned": 0},  # Automatic HIGH risk
    },
    "income": {
        "description": "Unexplained extreme wealth or income levels",
        "threshold": 1000000,
        "weights": {"above_threshold": 15, "below_threshold": 0},
    },
}
