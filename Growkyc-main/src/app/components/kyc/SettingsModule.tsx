          ...
          <div className="bg-white rounded-lg border border-gray-200 p-6">
            ...
            <div className="grid grid-cols-2 gap-6">
              ...
              <div>
                ...
                />
                <p className="text-xs text-gray-600 mt-1">Contact admin to change role</p>
              </div>
            ...
            <div className="space-y-4 max-w-md">
              ...
              <div>
                ...
                <input
                  ...
                  className="w-full px-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500"
                />
                <p className="text-xs text-gray-600 mt-1">Min 12 characters, including uppercase, lowercase, number & symbol</p>
              </div>
              ...
              <div className="p-4 bg-gray-50 rounded-lg">
                ...
                <div className="space-y-3">
                  <label className="flex items-center justify-between">
                    <span className="text-gray-900">New Client Onboarding</span>
                    <input
                      type="checkbox"
                  ...
                  <label className="flex items-center justify-between">
                    <span className="text-gray-900">Review Due Reminders</span>
                    <input
                      type="checkbox"
                  ...
                  <label className="flex items-center justify-between">
                    <span className="text-gray-900">Screening Matches (PEP/Sanctions)</span>
                    <input
                      type="checkbox"
                  ...
                  <label className="flex items-center justify-between">
                    <span className="text-gray-900">Daily Digest Email</span>
                    <input
                      type="checkbox"
              ...
              <div className="p-4 bg-green-50 border border-green-200 rounded-lg">
                <div className="flex items-center justify-between">
                  <div>
                    ...
                    <p className="text-sm text-green-800">Add an extra layer of security to your account</p>
                  </div>
                ...
                <div className="space-y-4">
                  ...
                  <label className="flex items-center gap-3">
                    <input
                      ...
                      className="w-5 h-5 text-blue-600"
                    />
                    <span className="text-gray-900">Send alerts for new device logins</span>
                  </label>
                </div>
              </div>
                ...
                <div className="space-y-3">
                  <div className="flex items-center justify-between p-3 bg-white rounded-lg border border-gray-200">
                    <div>
                      ...
                      <p className="text-sm text-gray-600">Melbourne, Australia • Chrome on macOS</p>
      ...
      {activeTab === 'system' && (
        <div className="space-y-6">
          <div className="bg-white rounded-lg border border-gray-200 p-6">
            ...
            <div className="space-y-6">
              <div className="p-4 bg-gray-50 rounded-lg">
                <h4 className="font-semibold text-gray-900 mb-3">Auto-Save Settings</h4>
                <div className="space-y-4">
                  <label className="flex items-center gap-3">
                    <input
                      type="checkbox"
                      ...
                      className="w-5 h-5 text-blue-600"
                    />
                    <span className="text-gray-900">Enable auto-save for forms and documents</span>
                  </label>
              ...
              <div className="p-4 bg-gray-50 rounded-lg">
                <h4 className="font-semibold text-gray-900 mb-3">Risk Assessment Defaults</h4>
                <div className="space-y-4">
                  <div>
                    <label className="block text-sm font-semibold text-gray-900 mb-2">
                    ...
                    <input
                      ...
                      className="w-full max-w-xs px-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500"
                    />
                    <p className="text-xs text-gray-600 mt-1">Score of {settings.defaultRiskThreshold} or above = High Risk</p>
                  </div>
                  ...
                  <div>
                    ...
                    <input
                      ...
                      className="w-full max-w-xs px-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500"
                    />
                    <p className="text-xs text-gray-600 mt-1">Score of {settings.requireApprovalThreshold} or above = Senior Approval Required</p>
                  </div>
                </div>
              </div>
      ...
      {activeTab === 'integrations' && (
        <div className="space-y-4">
          {[
            ...
            return (
              <div key={integration.name} className="bg-white rounded-lg border border-gray-200 p-6">
                <div className="flex items-center justify-between">
                  <div className="flex items-center gap-4">
