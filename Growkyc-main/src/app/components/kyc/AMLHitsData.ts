  ...
  'client-004': {
    sanctions: [
      ...
      },
      {
        ...
        listName: 'DFAT Consolidated List (Australia)',
        matchStrength: 'High',
        matchPercentage: 96,
        country: 'Russia',
        dateAdded: '2022-03-15',
        reason: 'Autonomous Sanctions (Designated Persons and Entities and Declared Persons—Russia) Instrument 2022. Subject to asset freeze and travel ban.',
        source: 'Department of Foreign Affairs and Trade (DFAT)',
        sourceUrl: 'https://www.dfat.gov.au/international-relations/security/sanctions/consolidated-list'
      },
      {
        id: 'sanc-004-3',
        ...
        reason: 'Individual designated under UN sanctions regime for involvement in international trade activities supporting sanctioned regimes.',
