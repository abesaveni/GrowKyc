  ...
  const renderOverview = () => (
    <div className="space-y-6">
        ...
        <CardContent className="p-8">
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-4">
              ...
              <div>
                <h2 className="text-3xl font-bold text-slate-100 mb-2">Compliance Status: Active</h2>
                <p className="text-slate-300 text-lg">All 22 AI-powered bots have verified your profile across 5 tiers</p>
            ...
            <div className="text-right">
              <p className="text-6xl font-bold text-green-400">{complianceScore}%</p>
      ...
      <div className="grid md:grid-cols-4 gap-6">
        <Card className="border-2 border-blue-300 bg-blue-500/10">
          <CardContent className="p-6">
            ...
            <p className="text-xs text-blue-400 mt-2">4 verified, 1 pending</p>
          </CardContent>
        </Card>
        ...
        <Card className="border-2 border-green-300 bg-green-500/10">
          <CardContent className="p-6">
            <div className="flex items-center gap-3 mb-3">
              ...
              <div>
                <p className="text-3xl font-bold text-green-300">12/12</p>
                <p className="text-sm text-green-300">Checks Passed</p>
              </div>
            </div>
            <Progress value={100} className="h-2 bg-green-500/20" />
            <p className="text-xs text-green-400 mt-2">All tiers complete</p>
          </CardContent>
        </Card>
        ...
        <Card className="border-2 border-amber-300 bg-amber-500/10">
          <CardContent className="p-6">
            ...
            <p className="text-xs text-amber-400 mt-2">1 flagged for review</p>
          </CardContent>
        </Card>
        ...
        <Card className="border-2 border-purple-300 bg-purple-500/10">
          <CardContent className="p-6">
            <div className="flex items-center gap-3 mb-3">
              ...
              <div>
                <p className="text-3xl font-bold text-purple-300">Live</p>
                <p className="text-sm text-purple-300">Monitoring</p>
              </div>
            </div>
      ...
      <Card className="border-2 border-amber-300 bg-amber-500/10">
        ...
        <CardContent>
          <div className="flex items-center justify-between p-4 bg-white rounded-lg border border-amber-500/30">
            <div>
              <p className="font-semibold text-slate-100">1 Transaction Pending Review</p>
              <p className="text-sm text-slate-300">International transfer flagged by Monitoring Bot - manual review required</p>
            </div>
              ...
              >
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-xs text-slate-400 mt-1">Verified by: {doc.verifiedBy}</p>
                  </div>
                </div>
        ...
        <CardContent>
          <div className="space-y-4">
            <div className="grid md:grid-cols-5 gap-4">
              <div className="text-center p-4 bg-white rounded-lg border border-green-500/30">
                <p className="text-3xl font-bold text-blue-400">5</p>
                <p className="text-xs text-slate-300">Tier 1 Checks</p>
              </div>
              <div className="text-center p-4 bg-white rounded-lg border border-green-500/30">
                <p className="text-3xl font-bold text-indigo-400">4</p>
                <p className="text-xs text-slate-300">Tier 2 Checks</p>
              </div>
              <div className="text-center p-4 bg-white rounded-lg border border-green-500/30">
                <p className="text-3xl font-bold text-green-400">3</p>
                <p className="text-xs text-slate-300">Tier 3 Bots</p>
              </div>
              <div className="text-center p-4 bg-white rounded-lg border border-green-500/30">
                <p className="text-3xl font-bold text-amber-400">4</p>
                <p className="text-xs text-slate-300">Tier 4 Analysis</p>
              </div>
              <div className="text-center p-4 bg-white rounded-lg border border-green-500/30">
                <p className="text-3xl font-bold text-purple-400">6</p>
                <p className="text-xs text-slate-300">Tier 5 Systems</p>
              </div>
            </div>

            <div className="p-4 bg-white rounded-lg border border-green-500/30">
              <h4 className="font-bold text-green-300 mb-2">What This Means:</h4>
