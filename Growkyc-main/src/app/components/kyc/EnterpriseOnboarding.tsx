...
export function EnterpriseOnboarding() {
    ...
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-4 gap-6">
        <div className="bg-white rounded-lg border border-gray-200 p-6">
          ...
          <p className="text-4xl font-bold text-gray-900 mb-2">492</p>
          <p className="text-sm text-green-600">↑ 18% growth</p>
        </div>

        <div className="bg-white rounded-lg border border-gray-200 p-6">
          <div className="flex items-center justify-between mb-4">
            <h3 className="font-semibold text-gray-900">Avg Risk Score</h3>
        ...
        <div className="bg-white rounded-lg border border-gray-200 p-6">
          ...
          <p className="text-4xl font-bold text-gray-900 mb-2">98.7%</p>
          <p className="text-sm text-green-600">AUSTRAC compliant</p>
        </div>
        ...
        <div className="bg-white rounded-lg border border-gray-200 p-6">
          ...
          <p className="text-4xl font-bold text-gray-900 mb-2">15.2K</p>
          ...
          <div className="space-y-4">
            <div>
              <div className="flex items-center justify-between mb-2">
                <span className="text-sm font-semibold text-green-900">Low Risk (0-30)</span>
                <span className="text-lg font-bold text-green-600">312</span>
              </div>
              <div className="h-3 bg-gray-200 rounded-full overflow-hidden">
                <div className="h-full bg-green-600" style={{ width: '63%' }} />
              </div>
              <p className="text-xs text-gray-600 mt-1">63% of portfolio</p>
            </div>

            <div>
              <div className="flex items-center justify-between mb-2">
                <span className="text-sm font-semibold text-yellow-900">Medium Risk (31-60)</span>
                <span className="text-lg font-bold text-yellow-600">156</span>
              </div>
              <div className="h-3 bg-gray-200 rounded-full overflow-hidden">
                <div className="h-full bg-yellow-600" style={{ width: '32%' }} />
              </div>
              <p className="text-xs text-gray-600 mt-1">32% of portfolio</p>
            </div>

            <div>
              <div className="flex items-center justify-between mb-2">
                <span className="text-sm font-semibold text-red-900">High Risk (61-100)</span>
                <span className="text-lg font-bold text-red-600">24</span>
              </div>
              <div className="h-3 bg-gray-200 rounded-full overflow-hidden">
                <div className="h-full bg-red-600" style={{ width: '5%' }} />
              </div>
              <p className="text-xs text-gray-600 mt-1">5% of portfolio</p>
            </div>
          </div>
        </div>

        <div className="bg-white rounded-lg border border-gray-200 p-6">
          <h3 className="text-xl font-bold text-gray-900 mb-4">Commercial Control</h3>
  ...
  const renderClients = () => (
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        <h2 className="text-2xl font-bold text-gray-900">Client Onboarding Pipeline</h2>
      ...
      {/* State Pipeline */}
      <div className="bg-white rounded-lg border border-gray-200 p-6">
        <h3 className="font-bold text-gray-900 mb-4">Stage-Gated State Engine</h3>
        <div className="flex items-center justify-between">
          {[
      ...
      <div className="bg-white rounded-lg border border-gray-200 overflow-hidden">
        <table className="w-full">
          <thead className="bg-gray-50 border-b border-gray-200">
            <tr>
              <th className="px-6 py-3 text-left text-xs font-bold text-gray-900 uppercase">Client</th>
              <th className="px-6 py-3 text-left text-xs font-bold text-gray-900 uppercase">State</th>
              <th className="px-6 py-3 text-left text-xs font-bold text-gray-900 uppercase">Progress</th>
              <th className="px-6 py-3 text-left text-xs font-bold text-gray-900 uppercase">Risk</th>
              <th className="px-6 py-3 text-left text-xs font-bold text-gray-900 uppercase">Commercial</th>
              <th className="px-6 py-3 text-left text-xs font-bold text-gray-900 uppercase">Assigned</th>
                ...
                <tr key={client.id} className="hover:bg-gray-50">
                  <td className="px-6 py-4">
                    <div>
                      ...
                      <p className="text-sm text-gray-600">{client.id} • {client.type}</p>
                    </div>
                  </td>
                  <td className="px-6 py-4">
  ...
  const renderRiskEngine = () => (
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-3 gap-6">
        ...
        <div className="bg-white rounded-lg border border-gray-200 p-6">
          <h3 className="font-bold text-gray-900 mb-4">Commercial Control</h3>
          <div className="space-y-3">
            {[
      ...
      <div className="grid grid-cols-2 gap-6">
        <div className="bg-white rounded-lg border border-gray-200 p-6">
          <h3 className="font-bold text-gray-900 mb-4">Ongoing Monitoring Triggers</h3>
          <div className="space-y-3">
            {[
              ...
              <div key={item.trigger} className="flex items-center justify-between p-3 bg-blue-50 rounded-lg">
                <div>
                  <p className="font-semibold text-blue-900 text-sm">{item.trigger}</p>
                  <p className="text-xs text-blue-700">Frequency: {item.frequency}</p>
                </div>
                <span className="text-xs text-gray-600">{item.lastRun}</span>
              </div>
            ))}
          </div>
        </div>
        ...
        <div className="bg-white rounded-lg border border-gray-200 p-6">
          <h3 className="font-bold text-gray-900 mb-4">Risk Escalation Rules</h3>
          <div className="space-y-3">
            {[
              ...
              <div key={rule.condition} className="p-3 bg-orange-50 border border-orange-200 rounded-lg">
                ...
                <p className="text-xs text-orange-700">{rule.action}</p>
              </div>
            ))}
          </div>
        </div>
      ...
      <div className="bg-white rounded-lg border border-gray-200 p-6">
        ...
        <div className="space-y-3">
          {[
            ...
            <div key={webhook.event} className="flex items-center justify-between p-4 bg-gray-50 rounded-lg">
              <div>
                <p className="font-semibold text-gray-900 text-sm">{webhook.event}</p>
                <p className="text-xs text-gray-600 font-mono">{webhook.endpoint}</p>
              </div>
              <div className="flex items-center gap-2">
  ...
  const renderAudit = () => (
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-4 gap-6">
        ...
        <div className="bg-white rounded-lg border border-gray-200 p-6">
          <Eye className="w-12 h-12 text-purple-600 mb-3" />
          <p className="text-sm text-gray-600 mb-1">User Actions</p>
          <p className="text-4xl font-bold text-gray-900">8,934</p>
        </div>

        <div className="bg-white rounded-lg border border-gray-200 p-6">
          <Database className="w-12 h-12 text-green-600 mb-3" />
          <p className="text-sm text-gray-600 mb-1">System Events</p>
          <p className="text-4xl font-bold text-gray-900">6,313</p>
        </div>

        <div className="bg-white rounded-lg border border-gray-200 p-6">
          <Lock className="w-12 h-12 text-red-600 mb-3" />
          <p className="text-sm text-gray-600 mb-1">Immutable</p>
          <p className="text-4xl font-bold text-gray-900">100%</p>
        </div>
      </div>

      <div className="bg-white rounded-lg border border-gray-200 p-6">
        <h3 className="font-bold text-gray-900 mb-4">Event Stream (Real-time)</h3>
        <div className="space-y-2">
          {[
            ...
            <div key={idx} className="flex items-center justify-between p-3 bg-gray-50 rounded-lg font-mono text-xs">
              <div className="flex items-center gap-4">
                <span className="text-gray-500">{event.timestamp}</span>
                <span className={`px-2 py-1 rounded ${event.user === 'system' ? 'bg-blue-100 text-blue-700' : 'bg-purple-100 text-purple-700'}`}>
                  {event.user}
                </span>
                <span className="text-gray-900 font-semibold">{event.action}</span>
                <span className="text-blue-600">{event.entity}</span>
              </div>
              <span className="text-gray-500">{event.ip}</span>
            </div>
          ))}
        </div>
      </div>
      ...
      <div className="grid grid-cols-2 gap-6">
        <div className="bg-white rounded-lg border border-gray-200 p-6">
          <h3 className="font-bold text-gray-900 mb-4">Field-Level Change Tracking</h3>
          <div className="space-y-3">
            {[
              ...
              <div key={idx} className="p-3 bg-yellow-50 border border-yellow-200 rounded-lg">
                ...
                <div className="flex items-center gap-2 text-xs">
                  ...
                  <span>→</span>
                  <span className="px-2 py-1 bg-green-100 text-green-700 rounded">{change.after}</span>
                </div>
                <p className="text-xs text-gray-600 mt-2">Changed by: {change.user}</p>
              </div>
            ))}
          </div>
        </div>
        ...
        <div className="bg-white rounded-lg border border-gray-200 p-6">
          <h3 className="font-bold text-gray-900 mb-4">Compliance Readiness</h3>
          <div className="space-y-3">
            {[
      ...
      <div className="max-w-7xl mx-auto p-6">
        ...
        {activeView === 'settings' && (
          <div className="bg-white rounded-lg border border-gray-200 p-8 text-center">
            ...
            <h3 className="text-2xl font-bold text-gray-900 mb-2">Settings & Configuration</h3>
            <p className="text-gray-600">System-wide settings and customization options</p>
          </div>
        )}
      </div>
    </div>
