...
export function ClientOnboardingPortal() {
  ...
  const renderWelcome = () => (
    <div className="max-w-3xl mx-auto text-center space-y-8">
      ...
      <div>
        <h1 className="text-4xl font-bold text-gray-900 mb-4">Welcome to Client Onboarding</h1>
      ...
      <div className="grid grid-cols-3 gap-6 mt-8">
        <div className="p-6 bg-white border-2 border-gray-200 rounded-lg">
          <Lock className="w-8 h-8 text-blue-600 mb-3 mx-auto" />
          <h4 className="font-bold text-gray-900 mb-2">Secure & Encrypted</h4>
        ...
        <div className="p-6 bg-white border-2 border-gray-200 rounded-lg">
          ...
          <h4 className="font-bold text-gray-900 mb-2">AUSTRAC Compliant</h4>
          <p className="text-sm text-gray-600">Meets all regulatory requirements</p>
        </div>
        <div className="p-6 bg-white border-2 border-gray-200 rounded-lg">
          <CheckCircle className="w-8 h-8 text-purple-600 mb-3 mx-auto" />
          <h4 className="font-bold text-gray-900 mb-2">Quick Process</h4>
          <p className="text-sm text-gray-600">Complete in under 20 minutes</p>
        </div>
      </div>
  ...
  const renderBusinessInfo = () => (
    <div className="max-w-4xl mx-auto space-y-6">
      <div className="mb-8">
        ...
        <p className="text-gray-600">Tell us about your business entity</p>
      </div>
      ...
      <div className="bg-white border-2 border-gray-200 rounded-lg p-6 space-y-6">
        <h3 className="text-xl font-bold text-gray-900">Primary Contact Information</h3>
  ...
  const renderBeneficialOwners = () => (
    <div className="max-w-4xl mx-auto space-y-6">
      <div className="mb-8">
        <h2 className="text-3xl font-bold text-gray-900 mb-2">Directors & Beneficial Owners</h2>
      ...
      <div className="bg-white border border-gray-200 rounded-lg p-4 mb-6">
        <div className="flex items-start gap-3">
          ...
          <div>
            <p className="font-semibold text-blue-900 mb-1">AML/CTF Requirement</p>
      ...
      <div className="bg-white border-2 border-gray-200 rounded-lg p-6">
        <div className="flex items-center justify-between mb-6">
          <h3 className="text-xl font-bold text-gray-900">Owner #1</h3>
          <span className="px-3 py-1 bg-blue-100 text-blue-700 text-sm font-bold rounded-full">PRIMARY</span>
        </div>
    ...
    <div className="max-w-4xl mx-auto space-y-6">
      ...
      <div className="bg-white border border-gray-200 rounded-lg p-4 mb-6">
        <div className="flex items-start gap-3">
          ...
          <div>
            <p className="font-semibold text-yellow-900 mb-1">Document Requirements</p>
      ...
      <div className="space-y-4">
        {documents.map((doc) => (
          <div key={doc.id} className="bg-white border-2 border-gray-200 rounded-lg p-6">
    ...
    <div className="max-w-3xl mx-auto space-y-6">
      ...
      <div className="grid grid-cols-3 gap-4">
        ...
        <div className="bg-white border-2 border-gray-200 rounded-lg p-6 text-center">
          ...
          <p className="text-sm text-gray-600">Verify documents</p>
        </div>
        <div className="bg-white border-2 border-blue-200 rounded-lg p-6 text-center">
          ...
          <p className="text-sm text-gray-600">Instant result</p>
        </div>
      </div>

      <div className="bg-white border-2 border-gray-200 rounded-lg p-6">
        <h3 className="font-bold text-gray-900 mb-4">Verification Checklist</h3>
      ...
      <div className="bg-white border-2 border-gray-200 rounded-lg p-6">
        ...
        <div className="grid grid-cols-2 gap-4">
          <div>
            ...
            <p className="font-semibold text-gray-900">{businessInfo.legalName || 'Not provided'}</p>
          </div>
          <div>
            <p className="text-sm text-gray-600">ABN</p>
            <p className="font-semibold text-gray-900">{businessInfo.abn || 'Not provided'}</p>
          </div>
          <div>
            <p className="text-sm text-gray-600">Entity Type</p>
            <p className="font-semibold text-gray-900">{businessInfo.entityType || 'Not provided'}</p>
          </div>
          <div>
            <p className="text-sm text-gray-600">Industry</p>
            <p className="font-semibold text-gray-900">{businessInfo.industryType || 'Not provided'}</p>
          </div>
        </div>
      </div>
    ...
    <div className="max-w-3xl mx-auto text-center space-y-8">
      ...
      <div className="grid grid-cols-3 gap-6">
        <div className="bg-white border-2 border-gray-200 rounded-lg p-6">
          ...
          <h4 className="font-bold text-gray-900 mb-2">Review Time</h4>
          <p className="text-sm text-gray-600">1-2 business days</p>
        </div>
        <div className="bg-white border-2 border-gray-200 rounded-lg p-6">
          <Mail className="w-8 h-8 text-purple-600 mb-3 mx-auto" />
          <h4 className="font-bold text-gray-900 mb-2">Email Updates</h4>
          <p className="text-sm text-gray-600">We'll keep you informed</p>
        </div>
        <div className="bg-white border-2 border-gray-200 rounded-lg p-6">
          <Phone className="w-8 h-8 text-green-600 mb-3 mx-auto" />
