          ...
          <div className="flex items-center justify-between">
            <div>
              <div className="flex items-center gap-3 mb-2">
                ...
                <div>
                  <h1 className="text-3xl font-bold text-gray-900">KYB Entity Verification Bot</h1>
                  <p className="text-gray-600">ABN/ACN validation • Registry lookup • Director verification</p>
                </div>
              </div>
            </div>
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-8">
          <Card className="border-2 hover:border-blue-400 transition-colors cursor-pointer">
            <CardContent className="p-4">
              ...
              <p className="text-sm font-medium text-gray-900">Pending Entities</p>
            </CardContent>
          </Card>
          ...
          <Card className="border-2 hover:border-amber-400 transition-colors cursor-pointer">
            <CardContent className="p-4">
              ...
              <p className="text-sm font-medium text-gray-900">Mismatches</p>
            </CardContent>
          </Card>
          ...
          <Card className="border-2 hover:border-red-400 transition-colors cursor-pointer">
            <CardContent className="p-4">
              ...
              <p className="text-sm font-medium text-gray-900">Failed Checks</p>
            </CardContent>
          </Card>
        </div>
              ...
              <div className="overflow-x-auto">
                <table className="w-full text-sm">
                  <thead className="bg-gray-50 border-b">
                    <tr>
                      <th className="px-4 py-3 text-left font-medium text-gray-700">Entity Name</th>
                      <th className="px-4 py-3 text-left font-medium text-gray-700">ABN</th>
                  ...
                  <tbody className="divide-y">
                    {[
                      ...
                      <tr key={idx} className="hover:bg-gray-50 cursor-pointer">
                        ...
                        <td className="px-4 py-3 text-xs text-gray-600">{item.abn}</td>
          ...
          <CardContent>
            <div className="grid md:grid-cols-3 gap-4">
              <div className="p-4 bg-green-50 border border-green-200 rounded-lg">
                ...
                <p className="font-semibold text-gray-900 mb-1">ABR Lookup</p>
              ...
              <div className="p-4 bg-green-50 border border-green-200 rounded-lg">
                ...
                <p className="font-semibold text-gray-900 mb-1">ASIC Registry</p>
              ...
              <div className="p-4 bg-green-50 border border-green-200 rounded-lg">
                ...
                <p className="font-semibold text-gray-900 mb-1">GST Status</p>
                <p className="text-xs text-gray-600">Real-time validation</p>
              </div>
            </div>
          </CardContent>
        </Card>
      ...
      <div className="bg-white border-b border-gray-200">
        <div className="max-w-5xl mx-auto px-8 py-6">
          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              <h1 className="text-2xl font-bold text-gray-900">Entity Verification Wizard</h1>
              <p className="text-gray-600">Verify business details against official registries</p>
            </div>
          </div>
          ...
          <div className="mt-6 flex items-center justify-between max-w-xl">
            {[
              ...
              <div key={s.num} className="flex items-center">
                ...
                <div className="ml-2">
                  <p className={`text-xs font-medium ${step >= s.num ? 'text-green-600' : 'text-gray-500'}`}>
                    {s.label}
                  </p>
                </div>
          ...
          <Card className="border-2">
            ...
            <CardContent className="p-8">
              <div className="text-center space-y-6">
                ...
                <div>
                  <p className="text-lg font-semibold text-gray-900 mb-2">Searching Official Registries</p>
                ...
                <table className="w-full text-sm">
                  <thead className="bg-gray-50 border-b">
                    <tr>
                      ...
                      <th className="px-4 py-3 text-left font-medium text-gray-700">Provided</th>
                      <th className="px-4 py-3 text-left font-medium text-gray-700">Registry</th>
                  ...
                  <tbody className="divide-y">
                    <tr>
                      ...
                      <td className="px-4 py-3 text-gray-700">{formData.entityName}</td>
                      <td className="px-4 py-3 text-gray-700">{registryData.name}</td>
                      <td className="px-4 py-3">
                    ...
                    <tr>
                      <td className="px-4 py-3 font-medium text-gray-900">ABN</td>
                      <td className="px-4 py-3 text-gray-700">{formData.abn}</td>
                      <td className="px-4 py-3 text-gray-700">{registryData.abn}</td>
                      <td className="px-4 py-3">
                        <Badge className="bg-green-100 text-green-700">
                          <CheckCircle className="w-3 h-3 mr-1" /> Match
                        </Badge>
                    ...
                    <tr>
                      <td className="px-4 py-3 font-medium text-gray-900">ACN</td>
                      <td className="px-4 py-3 text-gray-700">{formData.acn}</td>
                      <td className="px-4 py-3 text-gray-700">{registryData.acn}</td>
                      <td className="px-4 py-3">
                        <Badge className="bg-green-100 text-green-700">
                          <CheckCircle className="w-3 h-3 mr-1" /> Match
                        </Badge>
                    ...
                    <tr>
                      ...
                      <td className="px-4 py-3 text-gray-700">{registryData.status}</td>
                      <td className="px-4 py-3">
                        <Badge className="bg-green-100 text-green-700">
                    ...
                    <tr>
                      <td className="px-4 py-3 font-medium text-gray-900">GST Status</td>
                      <td className="px-4 py-3 text-gray-700">-</td>
                      <td className="px-4 py-3 text-gray-700">{registryData.gstStatus}</td>
                      <td className="px-4 py-3">
                        <Badge className="bg-green-100 text-green-700">
        ...
        {step === 4 && (
          <Card className="border-2 border-green-400">
            <CardContent className="p-8 text-center">
              ...
              <h2 className="text-3xl font-bold text-gray-900 mb-2">Entity Verified</h2>
              <p className="text-gray-600 mb-8">{registryData?.name}</p>
              ...
              <div className="max-w-2xl mx-auto space-y-4 mb-8">
                <div className="grid md:grid-cols-2 gap-4 text-left">
                  ...
                  <div className="p-4 bg-gray-50 rounded-lg">
                    <p className="text-xs text-gray-600">Entity Status</p>
                    <p className="font-semibold text-gray-900">Active</p>
                  </div>
                  <div className="p-4 bg-gray-50 rounded-lg">
                    <p className="text-xs text-gray-600">ABN</p>
                    <p className="font-semibold text-gray-900">{registryData?.abn}</p>
                  </div>
                  <div className="p-4 bg-gray-50 rounded-lg">
                    <p className="text-xs text-gray-600">ACN</p>
                    <p className="font-semibold text-gray-900">{registryData?.acn}</p>
                  </div>
                  <div className="p-4 bg-gray-50 rounded-lg">
                    <p className="text-xs text-gray-600">GST Status</p>
                    <p className="font-semibold text-green-600">Registered</p>
                  </div>
                  <div className="p-4 bg-gray-50 rounded-lg">
                    <p className="text-xs text-gray-600">Directors</p>
                    <p className="font-semibold text-gray-900">{registryData?.directors.length}</p>
                  </div>
                </div>
