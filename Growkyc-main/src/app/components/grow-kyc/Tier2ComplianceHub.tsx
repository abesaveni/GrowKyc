  ...
  return (
    <div className="min-h-screen bg-gray-50">
      <div className="bg-white border-b border-gray-200">
        <div className="max-w-7xl mx-auto px-8 py-6">
          ...
          <div className="flex items-center gap-4 mb-6">
            <div className="w-16 h-16 bg-gradient-to-br from-slate-800 to-slate-700 rounded-2xl flex items-center justify-center shadow-xl">
      ...
      <div className="max-w-7xl mx-auto px-8 py-8">
        ...
        {/* Tier 2 System Flow */}
        <Card className="mt-8 border-2 border-[#13B5EA] bg-gray-50">
          <CardHeader>
        ...
        <Card className="mt-8 bg-gray-50 border-2 border-green-300">
          <CardContent className="p-6">
