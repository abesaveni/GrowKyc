...
export function EquifaxClientProfileHub() {
  ...
  const renderModuleSummary = (moduleKey: keyof typeof clientProfile.modules, icon: any, title: string, description: string) => {
    ...
    return (
      <div className="bg-[#1e293b] dark:bg-gray-800 rounded-lg shadow-lg p-6 border-l-4 border-[#13B5EA] hover:shadow-xl transition-shadow">
              ...
              <div className="bg-[#1e293b] dark:bg-gray-800 rounded-lg shadow-lg p-6">
                ...
                <div className="space-y-3">
                  {['Identity Verification Report', 'AML Screening Report', 'Credit Report', 'Affordability Assessment', 'Property Valuation'].map((doc, i) => (
                    <div key={i} className="flex items-center justify-between p-4 bg-[#0f172a] dark:bg-gray-900 rounded-lg hover:bg-white/5 dark:hover:bg-gray-800 transition-colors">
                      <div className="flex items-center gap-3">
