  ...
  React.useEffect(() => {
    const interval = setInterval(() => {
      ...
      setAuditorStats(prev => {
        ...
        return {
          openFindings: Math.max(5, prev.openFindings + findingsChange),
          complianceChecks: prev.complianceChecks + checkChange,
          criticalIssues: Math.max(1, prev.criticalIssues + (findingsChange > 0 && Math.random() > 0.7 ? 1 : (findingsChange < 0 && Math.random() > 0.7 ? -1 : 0))),
          overallScore: Math.min(100, Math.max(90, parseFloat((prev.overallScore + scoreDelta).toFixed(1)))),
          mediumFindings: Math.max(3, prev.mediumFindings + (Math.random() > 0.8 ? (Math.random() > 0.5 ? 1 : -1) : 0)),
  ...
  const renderComplianceOfficerDashboard = () => (
    <div className="space-y-6 md:space-y-8 bg-white min-h-screen px-4 md:px-8 pb-8">
      ...
      <div className="bg-gradient-to-r from-[#13B5EA] to-[#0E7C9E] rounded-2xl p-6 md:p-12 text-white shadow-lg mt-4 md:mt-8">
        <div className="flex flex-col sm:flex-row items-center gap-4 sm:gap-6 mb-6 text-center sm:text-left">
          ...
          <div>
            ...
            <p className="text-white/90 text-sm md:text-xl">{userTitle} • {new Date().toLocaleDateString('en-US', { weekday: 'long', month: 'long', day: 'numeric' })}</p>
          </div>
        </div>
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 md:gap-6 mt-6 md:mt-8">
          ...
          >
            <div>
              <div className="text-3xl md:text-4xl font-bold mb-1">23</div>
          ...
          >
            <div>
              ...
              <div className="text-xs md:text-sm text-white/90 font-medium">Active Clients</div>
            </div>
            <div className="text-[10px] text-white/70 uppercase tracking-wider font-bold">Click to view</div>
          </div>
          <div
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 md:gap-6">
        <Card className="border-l-4 border-l-red-500 shadow-sm hover:shadow-md transition-all h-36 md:h-40 flex flex-col">
          <CardContent className="p-4 md:p-5 flex-1 flex flex-col justify-between">
            ...
            <div>
              ...
              <div className="flex items-center justify-between mt-2">
                <p className="text-[9px] md:text-[10px] text-red-600 font-black">+3 FROM YESTERDAY</p>
                <Button variant="link" className="text-[9px] md:text-[10px] p-0 h-auto font-black text-[#13B5EA]" onClick={onNavigateToCases}>VIEW ALL</Button>
              </div>
            </div>
          </CardContent>
        </Card>
        ...
        <Card className="border-l-4 border-l-amber-500 shadow-sm hover:shadow-md transition-all h-36 md:h-40 flex flex-col">
          <CardContent className="p-4 md:p-5 flex-1 flex flex-col justify-between">
            <div className="flex items-center justify-between">
              <div className="text-3xl md:text-4xl font-bold text-gray-900">23</div>
            ...
            <div>
              ...
              <div className="flex items-center justify-between mt-2">
                <p className="text-[9px] md:text-[10px] text-gray-500 font-black">12 DUE THIS WEEK</p>
                <Button variant="link" className="text-[9px] md:text-[10px] p-0 h-auto font-black text-[#13B5EA]" onClick={onNavigateToCases}>REVIEW QUEUE</Button>
              </div>
            </div>
          </CardContent>
        </Card>
        ...
        <Card className="border-l-4 border-l-green-500 shadow-sm hover:shadow-md transition-all h-36 md:h-40 flex flex-col">
          <CardContent className="p-4 md:p-5 flex-1 flex flex-col justify-between">
            <div className="flex items-center justify-between">
              <div className="text-3xl md:text-4xl font-bold text-gray-900">34</div>
              <CheckCircle className="w-6 h-6 md:w-8 md:h-8 text-green-500" />
            </div>
            <div>
              <div className="text-xs md:text-sm font-bold text-gray-700 uppercase tracking-wide">Completed Today</div>
              <div className="flex items-center justify-between mt-2">
                <p className="text-[9px] md:text-[10px] text-green-600 font-black">+12% VS AVG</p>
                <Button variant="link" className="text-[9px] md:text-[10px] p-0 h-auto font-black text-[#13B5EA]">DETAILS</Button>
              </div>
            </div>
          </CardContent>
        </Card>
        ...
        <Card className="border-l-4 border-l-blue-500 shadow-sm hover:shadow-md transition-all h-36 md:h-40 flex flex-col">
          <CardContent className="p-4 md:p-5 flex-1 flex flex-col justify-between">
            ...
            <div>
              ...
              <div className="flex items-center justify-between mt-2">
                <p className="text-[9px] md:text-[10px] text-gray-500 font-black">TEAM AVG SCORE</p>
                <Button variant="link" className="text-[9px] md:text-[10px] p-0 h-auto font-black text-[#13B5EA]">METRICS</Button>
              </div>
            </div>
          </CardContent>
        </Card>
              ...
              >
                <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 mb-3">
                  ...
                  <Button
                    size="sm"
                    variant="outline"
                    className="w-full sm:w-auto flex-shrink-0 text-center justify-center"
      ...
      <div className="bg-gradient-to-r from-purple-600 to-pink-600 rounded-xl p-6 md:p-8 text-white mt-4 md:mt-6">
        <div className="flex flex-col sm:flex-row gap-4 justify-between sm:items-center">
          ...
          <div className="text-center sm:text-right">
            ...
            <div className="text-3xl md:text-4xl font-bold">96.5%</div>
          </div>
        </div>
      </div>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 md:gap-6">
        ...
        >
          <CardContent className="p-5 md:p-8 relative z-10">
            ...
            <div className="text-4xl md:text-5xl font-black text-white mb-2 drop-shadow-md">326</div>
        ...
        >
          <CardContent className="p-5 md:p-8 relative z-10">
            ...
            <div className="text-4xl md:text-5xl font-black text-white mb-2 drop-shadow-md">12</div>
        ...
        >
          <CardContent className="p-5 md:p-8 relative z-10">
            ...
            <div className="text-4xl md:text-5xl font-black text-white mb-2 drop-shadow-md">3</div>
        ...
        <Card className="relative overflow-hidden bg-gradient-to-br from-indigo-600 to-violet-700 border-0 hover:shadow-2xl hover:scale-105 transition-all duration-300 group">
          <CardContent className="p-5 md:p-8 relative z-10">
            ...
            <div className="text-4xl md:text-5xl font-black text-white mb-2 drop-shadow-md">98.2%</div>
