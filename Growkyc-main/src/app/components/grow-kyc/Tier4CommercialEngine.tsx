        ...
        <div className="max-w-7xl mx-auto px-8 py-6">
          ...
          <div className="flex items-center gap-4 mb-6">
            ...
            <div>
              ...
              <h1 className="text-5xl font-bold text-gray-900">Business Intelligence Layer</h1>
              <p className="text-gray-600 text-xl">Turn compliance data into pricing, profitability & portfolio control</p>
            </div>
          </div>
          ...
          <div className="bg-gradient-to-r from-green-50 via-emerald-50 to-teal-50 border-4 border-green-400 rounded-xl p-8 shadow-2xl">
            ...
            <div className="grid md:grid-cols-4 gap-6">
              <div className="bg-white p-6 rounded-xl border-2 border-green-300 shadow-lg">
                ...
                <p className="font-bold text-gray-900 text-lg mb-2">Client Selection</p>
                <p className="text-sm text-gray-700">Score every client on compliance risk, operational burden, and profitability to drive retention and exit decisions</p>
              </div>
              <div className="bg-white p-6 rounded-xl border-2 border-blue-300 shadow-lg">
                ...
                <p className="font-bold text-gray-900 text-lg mb-2">Pricing Decisions</p>
                <p className="text-sm text-gray-700">Automatically recommend pricing based on entity complexity, risk level, and historical workload—risk = price premium</p>
              </div>
              <div className="bg-white p-6 rounded-xl border-2 border-purple-300 shadow-lg">
                ...
                <p className="font-bold text-gray-900 text-lg mb-2">Portfolio Risk Control</p>
                <p className="text-sm text-gray-700">Live firm-wide risk exposure: PEP concentration, geographic clusters, industry concentration—manage the portfolio</p>
              </div>
              <div className="bg-white p-6 rounded-xl border-2 border-amber-300 shadow-lg">
                ...
                <p className="font-bold text-gray-900 text-lg mb-2">Revenue Optimization</p>
                <p className="text-sm text-gray-700">Detect revenue leakage, underbilling, scope creep—recover lost revenue and improve margins</p>
              </div>
            </div>
        ...
        <div className="grid md:grid-cols-2 gap-8">
          ...
          >
            <CardContent className="p-8">
              ...
              <h2 className="text-3xl font-bold text-gray-900 mb-3">Client Risk & Profitability Bot</h2>
          ...
          >
            <CardContent className="p-8">
              ...
              <h2 className="text-3xl font-bold text-gray-900 mb-3">Pricing & Engagement Intelligence</h2>
              <p className="text-gray-700 mb-4 text-sm">
          ...
          >
            <CardContent className="p-8">
              ...
              <h2 className="text-3xl font-bold text-gray-900 mb-3">Portfolio Risk Dashboard</h2>
              <p className="text-gray-700 mb-4 text-sm">
          ...
          >
            <CardContent className="p-8">
              ...
              <h2 className="text-3xl font-bold text-gray-900 mb-3">Revenue Leakage & Billing Bot</h2>
              <p className="text-gray-700 mb-4 text-sm">
        ...
        <Card className="mt-8 border-4 border-green-500 bg-gradient-to-r from-green-50 via-emerald-50 to-teal-50 shadow-2xl">
          ...
          <CardContent className="p-8">
            ...
            <div className="bg-white rounded-xl border-2 border-green-300 p-6 shadow-lg">
              <h4 className="font-bold text-gray-900 text-xl mb-4">What Tier 4 Achieves:</h4>
        ...
        <div className="max-w-7xl mx-auto px-8 py-6">
          ...
          <div className="flex items-center gap-3 mb-6">
            ...
            <div>
              ...
              <h1 className="text-3xl font-bold text-gray-900">Client Risk & Profitability Bot</h1>
              <p className="text-gray-600">Score every client to drive retention and exit decisions</p>
            </div>
          </div>
        </div>
      </div>
              ...
              <table className="w-full text-sm">
                <thead className="bg-gray-50 border-b">
                  <tr>
                    ...
                    <th className="px-4 py-3 text-left font-medium text-gray-700">Margin</th>
                    <th className="px-4 py-3 text-left font-medium text-gray-700">Risk Score</th>
                ...
                <tbody className="divide-y">
                  {[
                    ...
                    <tr key={idx} className="hover:bg-gray-50 cursor-pointer">
                      ...
                      <td className="px-4 py-3 text-gray-700">{item.revenue}</td>
                      <td className="px-4 py-3 text-gray-700">{item.cost}</td>
                      <td className="px-4 py-3">
                        <span className={`font-semibold ${item.margin.includes('-') ? 'text-red-600' : item.margin.includes('6') ? 'text-green-600' : 'text-gray-700'}`}>
                          {item.margin}
                        </span>
                      </td>
                      <td className="px-4 py-3">
          ...
          <CardContent>
            <div className="grid md:grid-cols-2 gap-4">
              {[
                ...
                <div key={idx} className="bg-white p-4 rounded-lg border-2 border-green-200 flex items-center justify-between">
        ...
        <div className="max-w-7xl mx-auto px-8 py-6">
          ...
          <div className="flex items-center gap-3 mb-6">
            ...
            <div>
              ...
              <h1 className="text-3xl font-bold text-gray-900">Pricing & Engagement Intelligence Bot</h1>
              <p className="text-gray-600">Automated pricing recommendations based on risk and complexity</p>
            </div>
          </div>
        </div>
      </div>
          ...
          <CardContent>
            <div className="space-y-3">
              {[
                ...
                <div key={idx} className="bg-white p-3 rounded-lg border border-blue-200 flex items-center gap-3">
        ...
        <div className="max-w-7xl mx-auto px-8 py-6">
          ...
          <div className="flex items-center gap-3 mb-6">
            ...
            <div>
              ...
              <h1 className="text-3xl font-bold text-gray-900">Portfolio Risk Dashboard</h1>
              <p className="text-gray-600">Live firm-wide risk exposure and concentration monitoring</p>
            </div>
          </div>
        </div>
      </div>
          ...
          <CardContent>
            <div className="space-y-3">
              {[
                ...
                <div key={idx} className="bg-white p-4 rounded-lg border-2 border-purple-200 flex items-center justify-between">
                  <div>
        ...
        <div className="max-w-7xl mx-auto px-8 py-6">
          ...
          <div className="flex items-center gap-3 mb-6">
            ...
            <div>
              ...
              <h1 className="text-3xl font-bold text-gray-900">Revenue Leakage & Billing Bot</h1>
              <p className="text-gray-600">Detect and recover lost revenue from scope creep and underbilling</p>
            </div>
          </div>
        </div>
      </div>
