                    ...
                    <CardContent className="p-4">
                      ...
                      <div className="flex gap-2">
                        <Button 
                          ...
                          variant="outline"
                          onClick={() => {
                            toast.success(`📄 Opening full verification report for ${entity.name}`);
                            // In production, this would open a detailed report modal or new page
                          }}
                        >
                        ...
                        <Button 
                          ...
                          onClick={() => {
                            toast.success(`📥 Downloading compliance certificate for ${entity.name}`);
          ...
          <CardContent className="pt-6">
            ...
            <div className="flex gap-3">
              ...
              <Button 
                ...
                onClick={() => {
                  toast.success(`📥 Downloading complete verification package (${discoveredEntities.length + 1} reports)`);
                  // In production, this would trigger a ZIP file download with all PDFs
                }}
              >
                <Download className="w-4 h-4 mr-2" />
              ...
              return (
                <div key={step.id} className="flex-1 relative">
                  <div className="flex flex-col items-center">
                    ...
                    <span className={`text-sm mt-2 ${isActive ? 'font-bold text-blue-600' : 'text-slate-300'}`}>
                      {step.label}
                    </span>
                  </div>
