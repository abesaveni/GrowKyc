      ...
      <div className="relative overflow-hidden">
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-8 py-10 sm:py-16">
          <div className="text-center mb-12">
            ...
            <p className="text-lg sm:text-2xl text-gray-700 max-w-4xl mx-auto mb-6 px-2">
            ...
            <div className="flex items-center justify-center gap-2 flex-wrap max-w-3xl mx-auto">
              ...
              <Badge className="bg-gray-100 text-gray-700 border-gray-300 px-3 py-1.5 text-xs sm:text-sm">
                <CheckCircle className="w-4 h-4 mr-2" />
                ASIC RG78 + RG271
              </Badge>
            ...
            <CardHeader className="p-4 sm:p-6">
              <div className="flex flex-col sm:flex-row gap-4 sm:items-center justify-between">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <CardTitle className="text-gray-900 text-xl sm:text-2xl">5-Layer Architecture</CardTitle>
                ...
                <Button 
                  variant="outline" 
                  className="border-gray-300 text-gray-700 hover:bg-gray-100 w-full sm:w-auto justify-center"
