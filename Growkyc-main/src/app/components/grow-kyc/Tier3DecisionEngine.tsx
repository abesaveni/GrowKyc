        ...
        <div className="max-w-7xl mx-auto px-8 py-6">
          ...
          <div className="flex items-center gap-4 mb-6">
            ...
            <div>
              ...
              <h1 className="text-5xl font-bold text-gray-900">Autonomous Compliance System</h1>
              <p className="text-gray-600 text-xl">Not a tool. A live decision engine with autonomous monitoring.</p>
            </div>
          </div>
          ...
          <div className="bg-gradient-to-r from-red-50 via-orange-50 to-amber-50 border-4 border-red-400 rounded-xl p-8 shadow-2xl">
            ...
            <div className="grid md:grid-cols-3 gap-6">
              <div className="bg-white p-6 rounded-xl border-2 border-red-300 shadow-lg">
                ...
                <p className="font-bold text-gray-900 text-lg mb-2">Automated Decisions</p>
                <p className="text-sm text-gray-700">AI ingests all Tier 1 + 2 outputs and produces final risk ratings, onboarding decisions, and required controls with full explainability</p>
              </div>
              <div className="bg-white p-6 rounded-xl border-2 border-orange-300 shadow-lg">
                ...
                <p className="font-bold text-gray-900 text-lg mb-2">Live Monitoring</p>
                <p className="text-sm text-gray-700">System automatically triggers reviews when anything changes—PEP status, adverse media, ownership, directors—making compliance continuous, not static</p>
              </div>
              <div className="bg-white p-6 rounded-xl border-2 border-amber-300 shadow-lg">
                ...
                <p className="font-bold text-gray-900 text-lg mb-2">Audit-Ready QA</p>
                <p className="text-sm text-gray-700">Every file validated for completeness, compliance, and audit-readiness with automated checklists and issue detection</p>
              </div>
            </div>
      ...
      <div className="max-w-7xl mx-auto px-8 py-8">
        ...
        <div className="grid md:grid-cols-3 gap-8">
          ...
          >
            <CardContent className="p-8">
              ...
              <h2 className="text-3xl font-bold text-gray-900 mb-3">Compliance Decision Bot</h2>
          ...
          >
            <CardContent className="p-8">
              ...
              <h2 className="text-3xl font-bold text-gray-900 mb-3">Monitoring Trigger Bot</h2>
              <p className="text-gray-700 mb-4 text-sm">
          ...
          >
            <CardContent className="p-8">
              ...
              <h2 className="text-3xl font-bold text-gray-900 mb-3">Compliance File QA Bot</h2>
              <p className="text-gray-700 mb-4 text-sm">
        ...
        <Card className="mt-8 border-4 border-red-500 bg-gradient-to-r from-red-50 via-orange-50 to-amber-50 shadow-2xl">
          ...
          <CardContent className="p-8">
            ...
            <div className="bg-white rounded-xl border-2 border-red-300 p-6 shadow-lg">
              <h4 className="font-bold text-gray-900 text-xl mb-4">What Tier 3 Achieves:</h4>
        ...
        <div className="max-w-7xl mx-auto px-8 py-6">
          ...
          <div className="flex items-center gap-3 mb-6">
            ...
            <div>
              ...
              <h1 className="text-3xl font-bold text-gray-900">Compliance Decision Bot</h1>
              <p className="text-gray-600">AI-powered autonomous decision engine</p>
            </div>
          </div>
        </div>
      </div>
            ...
            <div className="overflow-x-auto">
              <table className="w-full text-sm">
                <thead className="bg-gray-50 border-b">
                  <tr>
                    <th className="px-4 py-3 text-left font-medium text-gray-700">Client / Entity</th>
                    <th className="px-4 py-3 text-left font-medium text-gray-700">Risk Score</th>
                    <th className="px-4 py-3 text-left font-medium text-gray-700">Key Flags</th>
                ...
                <tbody className="divide-y">
                  {[
                    ...
                    <tr key={idx} className="hover:bg-gray-50 cursor-pointer">
                      ...
                      <td className="px-4 py-3 text-xs text-gray-600">{item.flags}</td>
                      <td className="px-4 py-3">
                        <Badge className={
                      ...
                      <td className="px-4 py-3 text-xs text-gray-600">{item.assigned}</td>
                      <td className="px-4 py-3">
                        <span className={
          ...
          <CardContent>
            <div className="grid md:grid-cols-2 gap-4">
              {[
                ...
                <div key={idx} className="bg-white p-4 rounded-lg border-2 border-red-200 flex items-center justify-between">
        ...
        <div className="max-w-7xl mx-auto px-8 py-6">
          ...
          <div className="flex items-center gap-3 mb-6">
            ...
            <div>
              ...
              <h1 className="text-3xl font-bold text-gray-900">Monitoring Trigger Bot</h1>
              <p className="text-gray-600">Continuous compliance monitoring with auto-triggered reviews</p>
            </div>
          </div>
        </div>
      </div>
              ...
              <table className="w-full text-sm">
                <thead className="bg-gray-50 border-b">
                  <tr>
                    ...
                    <th className="px-4 py-3 text-left font-medium text-gray-700">Change Type</th>
                    ...
                    <th className="px-4 py-3 text-left font-medium text-gray-700">Triggered Action</th>
                  </tr>
                </thead>
                <tbody className="divide-y">
                  {[
                    ...
                    <tr key={idx} className="hover:bg-gray-50 cursor-pointer">
                      <td className="px-4 py-3 font-medium text-gray-900">{alert.subject}</td>
                      <td className="px-4 py-3 text-xs text-gray-700">{alert.change}</td>
                      <td className="px-4 py-3 text-xs text-gray-600">{alert.time}</td>
                      <td className="px-4 py-3">
                        <Badge className={
          ...
          <CardContent>
            <div className="space-y-3">
              {[
                ...
                <div key={idx} className="bg-white p-3 rounded-lg border border-orange-200 flex items-center gap-3">
        ...
        <div className="max-w-7xl mx-auto px-8 py-6">
          ...
          <div className="flex items-center gap-3 mb-6">
            ...
            <div>
              ...
              <h1 className="text-3xl font-bold text-gray-900">Compliance File QA Bot</h1>
              <p className="text-gray-600">Automated file validation for completeness and audit-readiness</p>
            </div>
          </div>
        </div>
      </div>
          ...
          <CardContent>
            <div className="grid md:grid-cols-2 gap-3">
              {[
                ...
                <div key={idx} className="bg-white p-3 rounded-lg border-2 border-red-300 flex items-center gap-3">
