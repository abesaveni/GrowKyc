    ...
    <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
      <Card className="relative overflow-hidden">
        ...
        <CardContent className="p-6 relative">
          ...
          <p className="text-sm text-slate-300 mb-1">Payment Volume Today</p>
          <p className="text-3xl font-bold text-slate-100">$1.2M</p>
          <p className="text-xs text-slate-400 mt-2">2,847 transactions</p>
        </CardContent>
      </Card>
      ...
      <Card className="relative overflow-hidden">
        ...
        <CardContent className="p-6 relative">
          ...
          <p className="text-sm text-slate-300 mb-1">Approval Rate</p>
          <p className="text-3xl font-bold text-slate-100">96.8%</p>
          <p className="text-xs text-slate-400 mt-2">Across all rails</p>
        </CardContent>
      </Card>
      ...
      <Card className="relative overflow-hidden">
        ...
        <CardContent className="p-6 relative">
          ...
          <p className="text-sm text-slate-300 mb-1">Fraud Alerts</p>
      ...
      <Card className="relative overflow-hidden">
        ...
        <CardContent className="p-6 relative">
          ...
          <p className="text-sm text-slate-300 mb-1">Chargeback Ratio</p>
          <p className="text-3xl font-bold text-slate-100">0.4%</p>
          <p className="text-xs text-slate-400 mt-2">Below threshold</p>
        </CardContent>
      </Card>
    </div>
          ...
          {[
            ...
            <div key={item.rail}>
              <div className="flex items-center justify-between mb-2">
                <span className="text-sm font-medium text-slate-300">{item.rail}</span>
                <span className="text-sm font-semibold text-slate-100">{item.volume}</span>
              </div>
              <div className="flex items-center gap-3">
                <div className="flex-1 bg-white/10 rounded-full h-3">
                  <div className={`${item.color} h-3 rounded-full`} style={{ width: `${item.share}%` }} />
                </div>
                <span className="text-xs text-slate-400 w-12">{item.share}%</span>
              </div>
              <p className="text-xs text-slate-400 mt-1">{item.count} transactions</p>
            </div>
          ))}
        </div>
      </CardContent>
            ...
            {[
              ...
              <div key={idx} className="flex items-center justify-between p-3 border rounded-lg hover:bg-white/5">
                <div className="flex-1">
                  ...
                  <p className="text-xs text-slate-400">Aging: {item.aging}</p>
                </div>
                <div className="flex items-center gap-3">
        ...
        <CardContent>
          <div className="space-y-3">
            {[
              ...
              <div key={idx} className="flex items-center justify-between p-3 border rounded-lg hover:bg-white/5">
                <div className="flex-1">
                  <p className="font-semibold text-slate-100">{merchant.name}</p>
                  <p className="text-xs text-slate-400">Volume: {merchant.volume}</p>
                </div>
                <div className="flex items-center gap-3">
                  <div className="text-right">
                    <p className="text-sm font-bold text-slate-100">{merchant.score}</p>
    ...
    <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
      <Card>
        <CardContent className="p-6">
          <div className="flex items-center justify-between mb-2">
            <span className="text-sm text-slate-300">Daily Sales</span>
            <DollarSign className="w-5 h-5 text-green-400" />
          </div>
          <p className="text-3xl font-bold text-slate-100">$42.5K</p>
          <p className="text-xs text-green-400 mt-1">↑ 18.2% vs yesterday</p>
        </CardContent>
      </Card>
      ...
      <Card>
        <CardContent className="p-6">
          <div className="flex items-center justify-between mb-2">
            <span className="text-sm text-slate-300">Pending Settlement</span>
      ...
      <Card>
        <CardContent className="p-6">
          <div className="flex items-center justify-between mb-2">
            <span className="text-sm text-slate-300">Failed Payments</span>
            <AlertCircle className="w-5 h-5 text-red-400" />
          </div>
          <p className="text-3xl font-bold text-slate-100">8</p>
          <p className="text-xs text-slate-400 mt-1">Auto-retry scheduled</p>
        </CardContent>
      </Card>
      ...
      <Card>
        <CardContent className="p-6">
          ...
          <p className="text-3xl font-bold text-slate-100">847</p>
        ...
        <div className="space-y-3">
          {[
            ...
            <div key={idx} className="flex items-center justify-between p-4 border rounded-lg">
              <div className="flex-1">
                <p className="font-semibold text-slate-100">{item.plan}</p>
                <p className="text-sm text-slate-300">{item.customers} customers</p>
              </div>
              <div className="text-right">
                <p className="text-lg font-bold text-slate-100">{item.mrr}</p>
                <p className="text-xs text-slate-400">Churn: {item.churn}</p>
              </div>
            </div>
          ))}
        </div>
  ...
  <div className="space-y-6">
    <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
      <Card>
        <CardContent className="p-6">
          <div className="flex items-center justify-between mb-2">
            <span className="text-sm text-slate-300">Loan Book Balance</span>
            <DollarSign className="w-5 h-5 text-blue-400" />
          </div>
          <p className="text-3xl font-bold text-slate-100">$8.2M</p>
          <p className="text-xs text-slate-400 mt-1">427 active loans</p>
        </CardContent>
      </Card>
      ...
      <Card>
        <CardContent className="p-6">
          <div className="flex items-center justify-between mb-2">
            <span className="text-sm text-slate-300">Arrears 30+ Days</span>
            <AlertCircle className="w-5 h-5 text-amber-400" />
          </div>
          <p className="text-3xl font-bold text-slate-100">$124K</p>
          <p className="text-xs text-amber-400 mt-1">1.5% of portfolio</p>
        </CardContent>
      </Card>
      ...
      <Card>
        <CardContent className="p-6">
          <div className="flex items-center justify-between mb-2">
            <span className="text-sm text-slate-300">Collections Tasks</span>
      ...
      <Card>
        <CardContent className="p-6">
          <div className="flex items-center justify-between mb-2">
            <span className="text-sm text-slate-300">Portfolio Yield</span>
            <Percent className="w-5 h-5 text-green-400" />
          </div>
          <p className="text-3xl font-bold text-slate-100">8.4%</p>
          ...
          <div className="space-y-3">
            {[
              ...
              <div key={idx} className="flex items-center justify-between p-3 border rounded-lg">
                ...
                <div className="text-right">
                  <p className="text-sm font-bold text-slate-100">{item.amount}</p>
        ...
        <CardContent>
          <div className="space-y-3">
            <div className="p-4 bg-green-500/10 border border-green-500/30 rounded-lg">
              <p className="text-sm text-slate-300 mb-1">Expected Repayments</p>
              <p className="text-2xl font-bold text-green-300">$842K</p>
            </div>
            <div className="p-4 bg-blue-500/10 border border-blue-500/30 rounded-lg">
              <p className="text-sm text-slate-300 mb-1">New Loans to Fund</p>
              <p className="text-2xl font-bold text-blue-300">$215K</p>
            </div>
            <div className="p-4 bg-white/5 border border-white/10 rounded-lg">
              <p className="text-sm text-slate-300 mb-1">Net Cash Position</p>
              <p className="text-2xl font-bold text-slate-100">+$627K</p>
            </div>
          </div>
        </CardContent>
      </Card>
          ...
          <table className="w-full">
            <thead className="bg-white/5">
              <tr>
                ...
                <th className="px-6 py-3 text-left text-xs font-semibold text-slate-300 uppercase">Payment Method</th>
                <th className="px-6 py-3 text-center text-xs font-semibold text-slate-300 uppercase">Active Plans</th>
                <th className="px-6 py-3 text-center text-xs font-semibold text-slate-300 uppercase">Risk Score</th>
                <th className="px-6 py-3 text-left text-xs font-semibold text-slate-300 uppercase">Last Payment</th>
            ...
            <tbody className="divide-y divide-white/10">
              {[
                ...
                <tr key={idx} className="hover:bg-white/5">
                  ...
                  <td className="px-6 py-4 text-sm text-slate-300">{customer.method}</td>
                  <td className="px-6 py-4 text-center text-sm font-semibold text-slate-100">{customer.plans}</td>
                  ...
                  <td className="px-6 py-4 text-sm text-slate-300">{customer.lastPayment}</td>
  ...
  <div className="space-y-6">
    <div className="flex items-center justify-between">
      <div className="flex items-center gap-3">
        ...
        <select className="px-3 py-2 border border-white/10 rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-blue-500">
      ...
      <CardContent className="p-0">
        <div className="overflow-x-auto">
          <table className="w-full">
            <thead className="bg-white/5">
              <tr>
                <th className="px-6 py-3 text-left text-xs font-semibold text-slate-300 uppercase">Payment ID</th>
                <th className="px-6 py-3 text-left text-xs font-semibold text-slate-300 uppercase">Customer</th>
                <th className="px-6 py-3 text-left text-xs font-semibold text-slate-300 uppercase">Rail</th>
                ...
                <th className="px-6 py-3 text-right text-xs font-semibold text-slate-300 uppercase">Fee</th>
            ...
            <tbody className="divide-y divide-white/10">
              {[
                ...
                <tr key={idx} className="hover:bg-white/5">
                  <td className="px-6 py-4 font-mono text-sm font-semibold text-slate-100">{payment.id}</td>
                  <td className="px-6 py-4 text-sm text-slate-100">{payment.customer}</td>
                  <td className="px-6 py-4">
                  ...
                  <td className="px-6 py-4 text-right text-sm text-slate-300">${payment.fee.toFixed(2)}</td>
                  <td className="px-6 py-4 text-sm text-slate-300">{payment.created}</td>
                  <td className="px-6 py-4 text-right">
                    <div className="flex items-center justify-end gap-2">
    ...
    <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
      <Card>
        <CardContent className="p-6">
          ...
          <p className="text-3xl font-bold text-slate-100">$84.8K</p>
          <p className="text-xs text-green-400 mt-1">↑ 12.4% MoM</p>
        </CardContent>
      </Card>
      ...
      <Card>
        <CardContent className="p-6">
          <div className="flex items-center justify-between mb-2">
            <span className="text-sm text-slate-300">Active Subscriptions</span>
            <Users className="w-5 h-5 text-blue-400" />
          </div>
          <p className="text-3xl font-bold text-slate-100">847</p>
          <p className="text-xs text-slate-400 mt-1">698 active plans</p>
        </CardContent>
      </Card>
      ...
      <Card>
        <CardContent className="p-6">
          <div className="flex items-center justify-between mb-2">
            <span className="text-sm text-slate-300">Churn Rate</span>
            <TrendingDown className="w-5 h-5 text-red-400" />
          </div>
          <p className="text-3xl font-bold text-slate-100">2.8%</p>
          <p className="text-xs text-green-400 mt-1">↓ 0.4% improvement</p>
        </CardContent>
      </Card>
      ...
      <Card>
        <CardContent className="p-6">
          <div className="flex items-center justify-between mb-2">
            <span className="text-sm text-slate-300">Unpaid Invoices</span>
            <AlertCircle className="w-5 h-5 text-amber-400" />
          </div>
          <p className="text-3xl font-bold text-slate-100">23</p>
          <p className="text-xs text-slate-400 mt-1">$12.4K total</p>
        </CardContent>
      </Card>
    </div>
            ...
            {[
              ...
              <div key={idx} className="flex items-center justify-between p-3 border rounded-lg hover:bg-white/5">
                <div className="flex-1">
                  ...
                  <p className="text-sm text-slate-400">{product.subscribers} subscribers</p>
                </div>
                <div className="text-right">
                  <p className="font-semibold text-slate-100">{product.price}</p>
        ...
        <CardContent>
          <div className="space-y-3">
            {[
              ...
              <div key={idx} className="flex items-center justify-between p-3 border rounded-lg hover:bg-white/5">
                <div className="flex-1">
                  <p className="font-mono text-sm font-semibold text-slate-100">{invoice.id}</p>
                  <p className="text-xs text-slate-400">{invoice.customer}</p>
                </div>
                <div className="text-right">
                  <p className="font-semibold text-slate-100">${invoice.amount}</p>
                  <span
                    className={`px-2 py-1 text-xs font-semibold rounded ${
                      invoice.status === 'paid' ? 'bg-green-500/15 text-green-300' : 'bg-amber-500/15 text-amber-300'
                    }`}
                  >
...
export const renderLoans = () => (
  <div className="space-y-6">
    ...
    <div className="grid grid-cols-1 md:grid-cols-5 gap-4">
      {[
        { status: 'Draft', count: 12, amount: '$340K', color: 'bg-white/5 text-slate-300' },
        { status: 'Under Review', count: 8, amount: '$280K', color: 'bg-blue-500/15 text-blue-300' },
        { status: 'Approved', count: 15, amount: '$520K', color: 'bg-green-500/15 text-green-300' },
        { status: 'Active', count: 427, amount: '$8.2M', color: 'bg-purple-500/15 text-purple-300' },
        { status: 'Arrears', count: 23, amount: '$340K', color: 'bg-red-500/15 text-red-300' }
      ].map((stage, idx) => (
        <Card key={idx}>
          <CardContent className="p-6">
            <p className="text-sm text-slate-300 mb-2">{stage.status}</p>
            <p className="text-2xl font-bold text-slate-100 mb-1">{stage.count}</p>
            <p className="text-xs text-slate-400">{stage.amount}</p>
          </CardContent>
        </Card>
      ))}
    </div>
      ...
      <CardContent>
        <div className="overflow-x-auto">
          <table className="w-full">
            <thead className="bg-white/5">
              <tr>
                <th className="px-6 py-3 text-left text-xs font-semibold text-slate-300 uppercase">Loan ID</th>
                <th className="px-6 py-3 text-left text-xs font-semibold text-slate-300 uppercase">Borrower</th>
                <th className="px-6 py-3 text-right text-xs font-semibold text-slate-300 uppercase">Amount</th>
                <th className="px-6 py-3 text-center text-xs font-semibold text-slate-300 uppercase">Status</th>
                <th className="px-6 py-3 text-right text-xs font-semibold text-slate-300 uppercase">Balance</th>
                <th className="px-6 py-3 text-left text-xs font-semibold text-slate-300 uppercase">Next Payment</th>
                <th className="px-6 py-3 text-right text-xs font-semibold text-slate-300 uppercase">Actions</th>
              </tr>
            </thead>
            <tbody className="divide-y divide-white/10">
              {[
                ...
                <tr key={idx} className="hover:bg-white/5">
                  <td className="px-6 py-4 font-mono text-sm font-semibold text-slate-100">{loan.id}</td>
                  <td className="px-6 py-4 text-sm text-slate-100">{loan.borrower}</td>
                  <td className="px-6 py-4 text-right font-semibold text-slate-100">${loan.amount.toLocaleString()}</td>
                  <td className="px-6 py-4 text-center">
                    <span
                      className={`px-2 py-1 text-xs font-semibold rounded ${
                        loan.status === 'active' ? 'bg-green-500/15 text-green-300' : 'bg-red-500/15 text-red-300'
                      }`}
                    >
                      {loan.status.toUpperCase()}
                    </span>
                  </td>
                  <td className="px-6 py-4 text-right font-semibold text-slate-100">${loan.balance.toLocaleString()}</td>
                  <td className="px-6 py-4 text-sm text-slate-300">{loan.nextPayment}</td>
                  <td className="px-6 py-4 text-right">
                    <div className="flex items-center justify-end gap-2">
    ...
    <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
      <Card>
        <CardContent className="p-6">
          ...
          <p className="text-3xl font-bold text-slate-100">$284K</p>
          <p className="text-xs text-slate-400 mt-1">12 batches</p>
        </CardContent>
      </Card>
      ...
      <Card>
        <CardContent className="p-6">
          <div className="flex items-center justify-between mb-2">
            <span className="text-sm text-slate-300">Settled Today</span>
            <CheckCircle className="w-5 h-5 text-green-400" />
          </div>
          <p className="text-3xl font-bold text-slate-100">$847K</p>
          <p className="text-xs text-slate-400 mt-1">24 batches</p>
        </CardContent>
      </Card>
      ...
      <Card>
        <CardContent className="p-6">
          <div className="flex items-center justify-between mb-2">
            <span className="text-sm text-slate-300">Failed Settlements</span>
            <XCircle className="w-5 h-5 text-red-400" />
          </div>
          <p className="text-3xl font-bold text-slate-100">3</p>
          <p className="text-xs text-slate-400 mt-1">$4.2K total</p>
        </CardContent>
      </Card>
      ...
      <Card>
        <CardContent className="p-6">
          <div className="flex items-center justify-between mb-2">
            <span className="text-sm text-slate-300">Reserve Held</span>
            <Shield className="w-5 h-5 text-blue-400" />
          </div>
          <p className="text-3xl font-bold text-slate-100">$124K</p>
          <p className="text-xs text-slate-400 mt-1">Rolling reserve</p>
        </CardContent>
      </Card>
    </div>
      ...
      <CardContent>
        <div className="overflow-x-auto">
          <table className="w-full">
            <thead className="bg-white/5">
              <tr>
                <th className="px-6 py-3 text-left text-xs font-semibold text-slate-300 uppercase">Batch ID</th>
                <th className="px-6 py-3 text-left text-xs font-semibold text-slate-300 uppercase">Date</th>
                <th className="px-6 py-3 text-left text-xs font-semibold text-slate-300 uppercase">Rail</th>
                <th className="px-6 py-3 text-right text-xs font-semibold text-slate-300 uppercase">Gross</th>
                <th className="px-6 py-3 text-right text-xs font-semibold text-slate-300 uppercase">Fees</th>
                <th className="px-6 py-3 text-right text-xs font-semibold text-slate-300 uppercase">Net</th>
                <th className="px-6 py-3 text-center text-xs font-semibold text-slate-300 uppercase">Count</th>
                <th className="px-6 py-3 text-center text-xs font-semibold text-slate-300 uppercase">Status</th>
              </tr>
            </thead>
            <tbody className="divide-y divide-white/10">
              {[
                ...
                <tr key={idx} className="hover:bg-white/5">
                  <td className="px-6 py-4 font-mono text-sm font-semibold text-slate-100">{batch.id}</td>
                  <td className="px-6 py-4 text-sm text-slate-300">{batch.date}</td>
                  <td className="px-6 py-4">
                    <span className="px-2 py-1 bg-white/5 text-slate-300 text-xs font-semibold rounded">
                      {batch.rail}
                    </span>
                  </td>
                  <td className="px-6 py-4 text-right font-semibold text-slate-100">${batch.gross.toLocaleString()}</td>
                  <td className="px-6 py-4 text-right text-sm text-red-400">${batch.fees.toLocaleString()}</td>
                  <td className="px-6 py-4 text-right font-bold text-green-300">${batch.net.toLocaleString()}</td>
                  <td className="px-6 py-4 text-center text-sm text-slate-300">{batch.count}</td>
                  <td className="px-6 py-4 text-center">
                    <span
                      className={`px-2 py-1 text-xs font-semibold rounded ${
                        batch.status === 'paid' ? 'bg-green-500/15 text-green-300' : 'bg-amber-500/15 text-amber-300'
                      }`}
                    >
      ...
      <Card>
        <CardContent className="p-6">
          <div className="flex items-center gap-3 mb-4">
            ...
            <div>
              <p className="text-sm text-slate-300">Gateway vs Sponsor</p>
      ...
      <Card>
        <CardContent className="p-6">
          <div className="flex items-center gap-3 mb-4">
            ...
            <div>
              <p className="text-sm text-slate-300">Sponsor vs Bank</p>
              <p className="text-2xl font-bold text-slate-100">99.1%</p>
            </div>
          </div>
          <p className="text-xs text-slate-400">Match rate</p>
        </CardContent>
      ...
      <Card>
        <CardContent className="p-6">
          <div className="flex items-center gap-3 mb-4">
            ...
            <div>
              <p className="text-sm text-slate-300">Total Exceptions</p>
              <p className="text-2xl font-bold text-slate-100">9</p>
            </div>
          </div>
          <p className="text-xs text-slate-400">Requires action</p>
        </CardContent>
      </Card>
    </div>
      ...
      <CardContent>
        <div className="overflow-x-auto">
          <table className="w-full">
            <thead className="bg-white/5">
              <tr>
                <th className="px-6 py-3 text-left text-xs font-semibold text-slate-300 uppercase">Exception ID</th>
                ...
                <th className="px-6 py-3 text-left text-xs font-semibold text-slate-300 uppercase">Aging</th>
            ...
            <tbody className="divide-y divide-white/10">
              {[
                ...
                <tr key={idx} className="hover:bg-white/5">
                  <td className="px-6 py-4 font-mono text-sm font-semibold text-slate-100">{exception.id}</td>
                  <td className="px-6 py-4 text-sm text-slate-100">{exception.type}</td>
                  <td className="px-6 py-4 text-right font-semibold text-slate-100">${exception.amount.toFixed(2)}</td>
                  <td className="px-6 py-4 text-center">
                    <span
                      className={`px-2 py-1 text-xs font-semibold rounded ${
                        exception.risk === 'high'
                  ...
                  <td className="px-6 py-4 text-sm text-slate-300">{exception.aging}</td>
                  <td className="px-6 py-4 text-sm text-slate-300">{exception.owner}</td>
                  <td className="px-6 py-4 text-right">
                    <div className="flex items-center justify-end gap-2">
...
export const renderLedger = () => (
  <div className="space-y-6">
    ...
    <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
      <Card>
        <CardContent className="p-6">
          <p className="text-sm text-slate-300 mb-2">Total Journals</p>
      ...
      <Card>
        <CardContent className="p-6">
          <p className="text-sm text-slate-300 mb-2">System Generated</p>
          <p className="text-3xl font-bold text-slate-100">1,189</p>
          <p className="text-xs text-slate-400 mt-1">95.3%</p>
        </CardContent>
      </Card>

      <Card>
        <CardContent className="p-6">
          <p className="text-sm text-slate-300 mb-2">Manual Entries</p>
          <p className="text-3xl font-bold text-slate-100">58</p>
          <p className="text-xs text-slate-400 mt-1">4.7%</p>
        </CardContent>
      </Card>

      <Card>
        <CardContent className="p-6">
          <p className="text-sm text-slate-300 mb-2">Period Status</p>
          <p className="text-3xl font-bold text-green-400">Open</p>
          <p className="text-xs text-slate-400 mt-1">Feb 2024</p>
        </CardContent>
      </Card>
    </div>
      ...
      <CardContent>
        <div className="overflow-x-auto">
          <table className="w-full">
            <thead className="bg-white/5">
              <tr>
                <th className="px-6 py-3 text-left text-xs font-semibold text-slate-300 uppercase">Journal ID</th>
                <th className="px-6 py-3 text-left text-xs font-semibold text-slate-300 uppercase">Date</th>
                <th className="px-6 py-3 text-left text-xs font-semibold text-slate-300 uppercase">Type</th>
                <th className="px-6 py-3 text-left text-xs font-semibold text-slate-300 uppercase">Description</th>
                <th className="px-6 py-3 text-right text-xs font-semibold text-slate-300 uppercase">Debit</th>
                <th className="px-6 py-3 text-right text-xs font-semibold text-slate-300 uppercase">Credit</th>
                <th className="px-6 py-3 text-right text-xs font-semibold text-slate-300 uppercase">Actions</th>
              </tr>
            </thead>
            <tbody className="divide-y divide-white/10">
              {[
                ...
                <tr key={idx} className="hover:bg-white/5">
                  <td className="px-6 py-4 font-mono text-sm font-semibold text-slate-100">{journal.id}</td>
                  <td className="px-6 py-4 text-sm text-slate-300">{journal.date}</td>
                  <td className="px-6 py-4">
                    <span
                      className={`px-2 py-1 text-xs font-semibold rounded ${
                        journal.type === 'System' ? 'bg-blue-500/15 text-blue-300' : 'bg-purple-500/15 text-purple-300'
                      }`}
                    >
                      {journal.type}
                    </span>
                  </td>
                  <td className="px-6 py-4 text-sm text-slate-300">{journal.description}</td>
                  <td className="px-6 py-4 text-right font-semibold text-slate-100">${journal.debit.toLocaleString()}</td>
                  <td className="px-6 py-4 text-right font-semibold text-slate-100">${journal.credit.toLocaleString()}</td>
                  <td className="px-6 py-4 text-right">
  ...
  <div className="space-y-6">
    ...
    <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
      <Card>
        <CardContent className="p-6">
          <div className="flex items-center justify-between mb-2">
            <span className="text-sm text-slate-300">Open Alerts</span>
            <AlertTriangle className="w-5 h-5 text-red-400" />
          </div>
          <p className="text-3xl font-bold text-slate-100">12</p>
          <p className="text-xs text-slate-400 mt-1">5 high priority</p>
        </CardContent>
      </Card>
      ...
      <Card>
        <CardContent className="p-6">
          <div className="flex items-center justify-between mb-2">
            <span className="text-sm text-slate-300">Fraud Rate</span>
            <Shield className="w-5 h-5 text-green-400" />
          </div>
          <p className="text-3xl font-bold text-slate-100">0.08%</p>
          <p className="text-xs text-green-400 mt-1">Below target</p>
        </CardContent>
      </Card>
      ...
      <Card>
        <CardContent className="p-6">
          <div className="flex items-center justify-between mb-2">
            <span className="text-sm text-slate-300">Blocked Transactions</span>
      ...
      <Card>
        <CardContent className="p-6">
          ...
          <p className="text-xs text-slate-400 mt-1">8 custom</p>
        </CardContent>
      </Card>
    </div>
            ...
            <div key={idx} className="flex items-center justify-between p-4 border rounded-lg hover:bg-white/5">
              <div className="flex-1">
                <div className="flex items-center gap-3 mb-1">
                  <p className="font-mono text-sm font-semibold text-slate-100">{alert.id}</p>
                  <span
                    className={`px-2 py-1 text-xs font-semibold rounded ${
                      alert.severity === 'high'
                        ? 'bg-red-500/15 text-red-300'
                ...
                <p className="text-sm text-slate-100">{alert.merchant}</p>
                <p className="text-xs text-slate-400">{alert.type} • {alert.amount} • {alert.triggered}</p>
              </div>
              <div className="flex items-center gap-2">
...
export const renderDisputes = () => (
  <div className="space-y-6">
    ...
    <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
      <Card>
        <CardContent className="p-6">
          <p className="text-sm text-slate-300 mb-2">Open Disputes</p>
          <p className="text-3xl font-bold text-slate-100">8</p>
          <p className="text-xs text-slate-400 mt-1">$4.2K total</p>
        </CardContent>
      </Card>
      ...
      <Card>
        <CardContent className="p-6">
          <p className="text-sm text-slate-300 mb-2">Win Rate</p>
      ...
      <Card>
        <CardContent className="p-6">
          <p className="text-sm text-slate-300 mb-2">Response Pending</p>
          <p className="text-3xl font-bold text-amber-400">3</p>
          <p className="text-xs text-slate-400 mt-1">Deadline approaching</p>
        </CardContent>
      </Card>

      <Card>
        <CardContent className="p-6">
          <p className="text-sm text-slate-300 mb-2">Chargeback Ratio</p>
          <p className="text-3xl font-bold text-slate-100">0.4%</p>
          <p className="text-xs text-green-400 mt-1">Below threshold</p>
        </CardContent>
      </Card>
    </div>
      ...
      <CardContent>
        <div className="overflow-x-auto">
          <table className="w-full">
            <thead className="bg-white/5">
              <tr>
                <th className="px-6 py-3 text-left text-xs font-semibold text-slate-300 uppercase">Dispute ID</th>
                <th className="px-6 py-3 text-left text-xs font-semibold text-slate-300 uppercase">Payment ID</th>
                <th className="px-6 py-3 text-left text-xs font-semibold text-slate-300 uppercase">Merchant</th>
                <th className="px-6 py-3 text-right text-xs font-semibold text-slate-300 uppercase">Amount</th>
                <th className="px-6 py-3 text-left text-xs font-semibold text-slate-300 uppercase">Reason</th>
                <th className="px-6 py-3 text-center text-xs font-semibold text-slate-300 uppercase">Status</th>
                <th className="px-6 py-3 text-left text-xs font-semibold text-slate-300 uppercase">Deadline</th>
                <th className="px-6 py-3 text-right text-xs font-semibold text-slate-300 uppercase">Actions</th>
              </tr>
            </thead>
            <tbody className="divide-y divide-white/10">
              {[
                ...
                <tr key={idx} className="hover:bg-white/5">
                  <td className="px-6 py-4 font-mono text-sm font-semibold text-slate-100">{dispute.id}</td>
                  <td className="px-6 py-4 font-mono text-xs text-slate-300">{dispute.paymentId}</td>
                  <td className="px-6 py-4 text-sm text-slate-100">{dispute.merchant}</td>
                  <td className="px-6 py-4 text-right font-semibold text-slate-100">${dispute.amount}</td>
                  <td className="px-6 py-4 text-sm text-slate-300">{dispute.reason}</td>
                  <td className="px-6 py-4 text-center">
                    <span
                      className={`px-2 py-1 text-xs font-semibold rounded ${
                        dispute.status === 'won'
                  ...
                  <td className="px-6 py-4 text-sm text-slate-300">{dispute.deadline}</td>
                  <td className="px-6 py-4 text-right">
  ...
  <div className="space-y-6">
    ...
    <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
      <Card>
        <CardContent className="p-6">
          <div className="flex items-center justify-between mb-2">
            <span className="text-sm text-slate-300">KYC Pending</span>
      ...
      <Card>
        <CardContent className="p-6">
          <div className="flex items-center justify-between mb-2">
            <span className="text-sm text-slate-300">Hardship Cases</span>
            <FileWarning className="w-5 h-5 text-blue-400" />
          </div>
          <p className="text-3xl font-bold text-slate-100">8</p>
          <p className="text-xs text-slate-400 mt-1">Open cases</p>
        </CardContent>
      </Card>
      ...
      <Card>
        <CardContent className="p-6">
          <div className="flex items-center justify-between mb-2">
            <span className="text-sm text-slate-300">Complaints</span>
            <AlertCircle className="w-5 h-5 text-purple-400" />
          </div>
          <p className="text-3xl font-bold text-slate-100">2</p>
          <p className="text-xs text-slate-400 mt-1">This month</p>
        </CardContent>
      </Card>
    </div>
            ...
            <div key={idx} className="flex items-center justify-between p-4 border rounded-lg hover:bg-white/5">
              <div className="flex-1">
                <div className="flex items-center gap-2 mb-1">
                  <p className="font-semibold text-slate-100">{item.merchant}</p>
                  <span
                    className={`px-2 py-1 text-xs font-semibold rounded ${
                      item.priority === 'high'
                        ? 'bg-red-500/15 text-red-300'
                ...
                <p className="text-xs text-slate-400">{item.type} verification • Submitted {item.submitted}</p>
              </div>
              <div className="flex items-center gap-3">
                <span
                  className={`px-2 py-1 text-xs font-semibold rounded ${
        ...
        return (
          <Card key={idx} className="cursor-pointer hover:shadow-lg transition-shadow" onClick={() => toast.info(`Opening ${category.title}`)}>
            <CardContent className="p-6">
              ...
              <h3 className="font-bold text-slate-100 mb-1">{category.title}</h3>
    ...
    <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
      <Card>
        <CardContent className="p-6">
          ...
          <p className="text-3xl font-bold text-slate-100">99.98%</p>
      ...
      <Card>
        <CardContent className="p-6">
          <div className="flex items-center justify-between mb-2">
            <span className="text-sm text-slate-300">API Calls (24h)</span>
            <Activity className="w-5 h-5 text-blue-400" />
          </div>
          <p className="text-3xl font-bold text-slate-100">124K</p>
          <p className="text-xs text-slate-400 mt-1">Avg 86/min</p>
        </CardContent>
      </Card>
      ...
      <Card>
        <CardContent className="p-6">
          <div className="flex items-center justify-between mb-2">
            <span className="text-sm text-slate-300">Webhook Success</span>
      ...
      <Card>
        <CardContent className="p-6">
          <div className="flex items-center justify-between mb-2">
            <span className="text-sm text-slate-300">Active Keys</span>
            <Key className="w-5 h-5 text-purple-400" />
          </div>
          <p className="text-3xl font-bold text-slate-100">8</p>
          <p className="text-xs text-slate-400 mt-1">3 production</p>
        </CardContent>
      </Card>
    </div>
            ...
            <div key={idx} className="flex items-center justify-between p-4 border rounded-lg hover:bg-white/5">
              <div className="flex-1">
                <div className="flex items-center gap-2 mb-1">
                  ...
                  <span
                    className={`px-2 py-1 text-xs font-semibold rounded ${
                      apiKey.env === 'live' ? 'bg-green-500/15 text-green-300' : 'bg-blue-500/15 text-blue-300'
                    }`}
                  >
                    {apiKey.env.toUpperCase()}
                  </span>
                </div>
                <p className="font-mono text-xs text-slate-300">{apiKey.key}</p>
                <p className="text-xs text-slate-400 mt-1">Created {apiKey.created} • Last used {apiKey.lastUsed}</p>
              </div>
              <div className="flex items-center gap-2">
                <Button size="sm" variant="ghost" onClick={() => toast.info('Rotate key')}>
                  <RefreshCw className="w-4 h-4" />
                </Button>
                <Button size="sm" variant="ghost" className="text-red-400" onClick={() => toast.warning('Key deleted')}>
      ...
      <CardContent>
        <div className="space-y-3">
          {[
            ...
            <div key={idx} className="flex items-center justify-between p-4 border rounded-lg hover:bg-white/5">
              <div className="flex-1">
                <p className="font-mono text-sm text-slate-100 mb-1">{webhook.url}</p>
                <p className="text-xs text-slate-400">{webhook.events.join(', ')}</p>
                <p className="text-xs text-slate-400 mt-1">Last delivery: {webhook.lastDelivery}</p>
              </div>
              <div className="flex items-center gap-2">
                <span className="px-2 py-1 bg-green-500/15 text-green-300 text-xs font-semibold rounded">
  ...
  <div className="space-y-6">
    <Card>
      ...
      <CardContent>
        <div className="space-y-6">
          <div>
            <h3 className="font-semibold text-slate-100 mb-4">General</h3>
            <div className="space-y-4">
              <div>
          ...
          <div className="border-t pt-6">
            <h3 className="font-semibold text-slate-100 mb-4">Payment Settings</h3>
            <div className="space-y-4">
              <div className="flex items-center justify-between">
                <div>
                  <p className="font-medium text-slate-100">Auto-retry failed payments</p>
                  <p className="text-sm text-slate-400">Automatically retry failed payment attempts</p>
                </div>
              ...
              <div className="flex items-center justify-between">
                <div>
                  <p className="font-medium text-slate-100">Email receipts</p>
                  <p className="text-sm text-slate-400">Send email receipts to customers</p>
                </div>
                <label className="relative inline-flex items-center cursor-pointer">
                  <input type="checkbox" className="sr-only peer" defaultChecked />
                  <div className="w-11 h-6 bg-white/10 peer-focus:outline-none peer-focus:ring-4 peer-focus:ring-blue-300 rounded-full peer peer-checked:after:translate-x-full peer-checked:after:border-white after:content-[''] after:absolute after:top-[2px] after:left-[2px] after:bg-white after:border-white/10 after:border after:rounded-full after:h-5 after:w-5 after:transition-all peer-checked:bg-blue-600"></div>
