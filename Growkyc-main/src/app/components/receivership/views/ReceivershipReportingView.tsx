    ...
    <div className="p-6 space-y-8 max-w-[1200px] mx-auto">
      ...
      <section className="bg-white border border-gray-200 rounded-xl p-6">
        <div className="flex items-center gap-3 mb-4">
          ...
          <h2 className="text-lg font-semibold text-gray-900">ASIC Form 504</h2>
        </div>
        ...
        <div className="grid md:grid-cols-2 gap-4">
          <div className="border border-gray-200 rounded-lg p-4">
            <h3 className="font-medium text-gray-900 mb-2">Remuneration report</h3>
            <p className="text-sm text-gray-600 mb-4">Receiver remuneration, disbursements, and approval status.</p>
          ...
          <div className="border border-gray-200 rounded-lg p-4">
            ...
            <p className="text-sm text-gray-600 mb-4">Matter progress, asset realisation, and creditor updates.</p>
        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-4">
          {REPORTS.map((r) => (
            <div key={r.id} className="bg-white border border-gray-200 rounded-lg p-5 hover:shadow-md transition-shadow">
              ...
              <p className="font-semibold text-gray-900 mt-1 mb-3">{r.name}</p>
