...
export function AIReviewEngine({ onNavigate }: AIReviewEngineProps) {
  ...
  const getLayerBadge = (layer: string) => {
    switch (layer) {
      case 'prep':
        return <span className="px-2 py-0.5 bg-blue-500/15 text-blue-300 text-xs font-semibold rounded">PREP</span>;
      case 'review':
        return <span className="px-2 py-0.5 bg-purple-500/15 text-purple-300 text-xs font-semibold rounded">REVIEW</span>;
      case 'advisory':
        return <span className="px-2 py-0.5 bg-green-500/15 text-green-300 text-xs font-semibold rounded">ADVISORY</span>;
      default:
        return null;
    }
  };
  ...
  const getStatusBadge = (status: string) => {
    switch (status) {
      case 'pending':
        return <span className="px-2 py-0.5 bg-amber-500/15 text-amber-300 text-xs font-semibold rounded">PENDING</span>;
      case 'reviewed':
        return <span className="px-2 py-0.5 bg-blue-500/15 text-blue-300 text-xs font-semibold rounded">REVIEWED</span>;
      case 'resolved':
        return <span className="px-2 py-0.5 bg-green-500/15 text-green-300 text-xs font-semibold rounded">RESOLVED</span>;
      case 'dismissed':
        return <span className="px-2 py-0.5 bg-white/5 text-slate-300 text-xs font-semibold rounded">DISMISSED</span>;
      default:
        return null;
    }
  };
      ...
      <div className="space-y-6">
        ...
        <div className="flex items-center justify-between">
          <div>
            ...
            <p className="text-sm text-slate-300 mt-1">3-Layer AI System • Preparation • Review • Advisory Intelligence</p>
          </div>
          <div className="flex items-center gap-2">
            <label className="flex items-center gap-2 text-sm px-3 py-2 bg-white border border-white/10 rounded">
              <input
                type="checkbox"
                checked={autoApprove}
                ...
                className="w-4 h-4"
              />
              <span className="text-slate-300 font-medium">Auto-approve high confidence</span>
            </label>
        ...
        <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-4">
          <div className="bg-white border border-white/10 rounded p-3">
            <div className="text-xs text-slate-300 mb-1">Total Findings</div>
            <div className="text-2xl font-bold text-slate-100 font-mono">{stats.total}</div>
          </div>
          <div className="bg-white border border-white/10 rounded p-3">
            <div className="text-xs text-slate-300 mb-1">Pending Review</div>
            <div className="text-2xl font-bold text-amber-400 font-mono">{stats.pending}</div>
          </div>
          <div className="bg-white border border-white/10 rounded p-3">
            <div className="text-xs text-slate-300 mb-1">Resolved</div>
            <div className="text-2xl font-bold text-green-400 font-mono">{stats.resolved}</div>
          </div>
          <div className="bg-white border border-white/10 rounded p-3">
            <div className="text-xs text-slate-300 mb-1">High Severity</div>
            <div className="text-2xl font-bold text-red-400 font-mono">{stats.highSeverity}</div>
          </div>
          <div className="bg-white border border-white/10 rounded p-3">
            <div className="text-xs text-slate-300 mb-1">Auto-Approved</div>
            <div className="text-2xl font-bold text-blue-400 font-mono">{stats.autoApproved}</div>
            <div className="text-xs text-green-400 font-semibold">67%</div>
          </div>
          <div className="bg-white border border-white/10 rounded p-3">
            <div className="text-xs text-slate-300 mb-1">Avg Confidence</div>
            <div className="text-2xl font-bold text-purple-400 font-mono">{stats.avgConfidence}%</div>
          </div>
        </div>

        {/* Layer Selector */}
        <div className="flex items-center gap-2">
          <span className="text-sm font-semibold text-slate-300">AI Layer:</span>
          <button
          ...
          <button
            ...
            className={`px-3 py-1.5 rounded text-sm font-semibold ${
              selectedLayer === 'review'
                ...
                : 'bg-purple-500/15 text-purple-300 hover:bg-purple-500/20'
            }`}
          >
        ...
        <div className="border border-white/10 rounded bg-white overflow-hidden">
          <div className="bg-white/5 border-b border-white/10 px-4 py-2">
            <h3 className="font-semibold text-slate-100">AI Review Findings</h3>
          </div>
          <div className="overflow-x-auto">
            <table className="w-full text-sm border-collapse">
              <thead>
                <tr className="bg-white/5">
                  <th className="border border-white/10 px-3 py-2 text-left font-semibold text-slate-300 w-24">Layer</th>
                  <th className="border border-white/10 px-3 py-2 text-left font-semibold text-slate-300">Category</th>
                  <th className="border border-white/10 px-3 py-2 text-center font-semibold text-slate-300 w-28">Severity</th>
                  <th className="border border-white/10 px-3 py-2 text-left font-semibold text-slate-300">Account</th>
                  <th className="border border-white/10 px-3 py-2 text-left font-semibold text-slate-300">Finding</th>
                  <th className="border border-white/10 px-3 py-2 text-left font-semibold text-slate-300">AI Suggestion</th>
                  <th className="border border-white/10 px-3 py-2 text-center font-semibold text-slate-300 w-20">Confidence</th>
                  <th className="border border-white/10 px-3 py-2 text-center font-semibold text-slate-300 w-28">Status</th>
              ...
              <tbody>
                {filteredItems.map((item) => (
                  <tr key={item.id} className="hover:bg-blue-500/10">
                    ...
                    <td className="border border-white/10 px-3 py-2 text-center">
                      <div className="font-mono font-semibold text-purple-300">{item.confidence}%</div>
                    ...
                    <td className="border border-white/10 px-2 py-2 text-center">
                      <div className="flex items-center gap-1">
                        <button className="p-1 text-green-400 hover:bg-green-500/15 rounded" title="Approve">
                        ...
                        <button 
                          ...
                          className="p-1 text-blue-400 hover:bg-blue-500/15 rounded" 
                          title="View Details"
                        >
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
          <div className="bg-blue-500/10 border border-blue-300 rounded p-4">
            <div className="flex items-center gap-2 mb-2">
              ...
              <h3 className="font-semibold text-blue-300">Layer 1: Preparation Assistant</h3>
            </div>
          ...
          <div className="bg-purple-500/10 border border-purple-300 rounded p-4">
            <div className="flex items-center gap-2 mb-2">
              ...
              <h3 className="font-semibold text-purple-300">Layer 2: Review Mode</h3>
            </div>
          ...
          <div className="bg-green-500/10 border border-green-300 rounded p-4">
            <div className="flex items-center gap-2 mb-2">
              ...
              <h3 className="font-semibold text-green-300">Layer 3: Advisory Intelligence</h3>
            </div>
