        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
          <Card className="relative overflow-hidden">
            ...
            <CardContent className="p-6 relative">
              ...
              <p className="text-sm text-gray-600 mb-1">Settlements This Week</p>
              <p className="text-3xl font-bold text-gray-900">24</p>
              <p className="text-xs text-gray-500 mt-2">$18.2M total value</p>
            </CardContent>
          </Card>
          ...
          <Card className="relative overflow-hidden">
            ...
            <CardContent className="p-6 relative">
              ...
              <p className="text-sm text-gray-600 mb-1">Overdue Conditions</p>
              <p className="text-3xl font-bold text-gray-900">8</p>
              <p className="text-xs text-gray-500 mt-2">Across 5 matters</p>
            </CardContent>
          </Card>
          ...
          <Card className="relative overflow-hidden">
            ...
            <CardContent className="p-6 relative">
              ...
              <p className="text-sm text-gray-600 mb-1">Tasks Due Today</p>
          ...
          <Card className="relative overflow-hidden">
            ...
            <CardContent className="p-6 relative">
              ...
              <p className="text-sm text-gray-600 mb-1">PEXA Workspaces</p>
              <p className="text-3xl font-bold text-gray-900">47</p>
              <p className="text-xs text-gray-500 mt-2">3 awaiting sync</p>
            </CardContent>
          </Card>
        </div>
        ...
        <Card>
          ...
          <CardContent>
            <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-8 gap-3">
              {[
                { stage: 'Intake', count: 8, color: 'bg-gray-100 text-gray-700' },
                { stage: 'Verification', count: 12, color: 'bg-blue-100 text-blue-700' },
                { stage: 'Conditions', count: 18, color: 'bg-amber-100 text-amber-700' },
                { stage: 'Doc Prep', count: 15, color: 'bg-purple-100 text-purple-700' },
                { stage: 'Signing', count: 9, color: 'bg-indigo-100 text-indigo-700' },
                { stage: 'Pre-Settlement', count: 6, color: 'bg-orange-100 text-orange-700' },
                { stage: 'Settlement', count: 4, color: 'bg-green-100 text-green-700' },
                { stage: 'Post-Settlement', count: 2, color: 'bg-emerald-100 text-emerald-700' }
              ].map((stage) => (
                <div
                  key={stage.stage}
            ...
            <CardContent>
              <div className="space-y-3">
                {[
                  ...
                  <div
                    key={matter.id}
                    className="p-4 border-l-4 border-red-500 bg-red-50 rounded-lg cursor-pointer hover:bg-red-100 transition-colors"
                    onClick={() => {
                  ...
                  >
                    <div className="flex items-start justify-between mb-2">
                      <p className="font-mono text-sm font-semibold text-gray-900">{matter.id}</p>
                      <span
                    ...
                    <p className="text-sm text-gray-900 font-medium mb-1">{matter.property}</p>
                    <div className="flex items-center justify-between">
                      <p className="text-xs text-gray-600">Settles: {matter.settlement}</p>
                      <p className="text-xs text-red-700 font-semibold">{matter.issue}</p>
                    </div>
                  </div>
                ))}
              </div>
                ...
                {[
                  ...
                  <div key={idx} className="p-3 border rounded-lg hover:bg-gray-50 transition-colors">
                    <div className="flex items-center gap-2 mb-2">
                      ...
                      <span className="font-mono text-xs font-semibold text-gray-900">{update.workspace}</span>
                    </div>
                    <p className="text-sm text-gray-900">{update.event}</p>
                    <div className="flex items-center justify-between mt-2">
                      <p className="text-xs text-gray-600">{update.matter}</p>
          ...
          <div className="space-y-3">
            {[
              ...
              >
                ...
                <p className="text-sm font-medium text-gray-900">{matter.property}</p>
                <p className="text-xs text-gray-600 mt-1">Settlement: {matter.settlement}</p>
              </div>
            ))}
          </div>
        </CardContent>
  ...
  <div className="space-y-6">
    ...
    <div className="flex items-center justify-between">
      <div className="flex items-center gap-3">
        ...
        <select className="px-3 py-2 border border-gray-300 rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-emerald-500">
        ...
        <div className="overflow-x-auto">
          <table className="w-full">
            <thead className="bg-gray-50">
              <tr>
                <th className="px-6 py-3 text-left text-xs font-semibold text-gray-600 uppercase">Matter ID</th>
                ...
                <th className="px-6 py-3 text-left text-xs font-semibold text-gray-600 uppercase">PEXA</th>
            ...
            <tbody className="divide-y divide-gray-200">
              {[
                ...
                >
                  <td className="px-6 py-4 font-mono text-sm font-semibold text-gray-900">{matter.id}</td>
                  ...
                  <td className="px-6 py-4 text-sm text-gray-600">{matter.type}</td>
                  <td className="px-6 py-4">
                    <span className="px-2 py-1 bg-blue-100 text-blue-700 text-xs font-semibold rounded">
                      {matter.stage}
                    </span>
                  </td>
                  <td className="px-6 py-4 text-sm text-gray-600">{matter.settlement}</td>
                  ...
                  <td className="px-6 py-4">
                    <div className="flex items-center gap-1">
                      ...
                      <span className="font-mono text-xs text-gray-600">{matter.pexa}</span>
                    </div>
                  </td>
        ...
        <div className="flex items-start justify-between mb-4">
          <div className="flex-1">
            <div className="flex items-center gap-3 mb-2">
              <h3 className="text-2xl font-bold text-gray-900">45 Collins Street, Melbourne VIC 3000</h3>
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mt-4">
              <div>
                <p className="text-xs text-gray-500">Matter ID</p>
                <p className="font-mono text-sm font-semibold text-gray-900">MAT-2024-1247</p>
              </div>
              <div>
              ...
              <div>
                ...
                <p className="text-sm font-semibold text-gray-900">20 Feb 2024, 2:00 PM</p>
              </div>
              <div>
                <p className="text-xs text-gray-500">PEXA Workspace</p>
                <div className="flex items-center gap-1">
                  <Link2 className="w-3 h-3 text-purple-600" />
                  <p className="font-mono text-sm font-semibold text-purple-600">WS-2024-5847</p>
                </div>
              </div>
            </div>
          </div>
        ...
        <div className="mt-6 pt-6 border-t">
          <div className="grid grid-cols-4 md:grid-cols-8 gap-2">
            {[
              ...
              >
                {stage.status === 'complete' && <CheckCircle className="w-4 h-4 text-green-600 mx-auto mb-1" />}
                {stage.status === 'current' && <Clock className="w-4 h-4 text-blue-600 mx-auto mb-1" />}
                ...
                <p className="text-xs text-gray-600">{stage.tasks} tasks</p>
              </div>
            ))}
          </div>
        </div>
        ...
        <CardContent className="p-6">
          <div className="flex items-center gap-4 mb-4">
            ...
            <div>
              ...
              <p className="text-sm text-gray-500">8 parties</p>
            </div>
          </div>
          <div className="flex items-center gap-2">
            ...
            <span className="text-sm text-gray-600">+4 more</span>
          </div>
        </CardContent>
      </Card>
      ...
      <Card className="cursor-pointer hover:shadow-lg transition-shadow" onClick={() => setCurrentPage('conditions')}>
        <CardContent className="p-6">
          <div className="flex items-center gap-4 mb-4">
            ...
            <div>
              <h3 className="font-bold text-gray-900">Conditions</h3>
              <p className="text-sm text-gray-500">12 total</p>
            </div>
          </div>
          <div className="flex items-center justify-between">
        ...
        <CardContent className="p-6">
          ...
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-4">
              ...
              <div>
                <p className="text-xs text-gray-500">Pending</p>
                <p className="text-lg font-bold text-amber-600">13</p>
              </div>
            </div>
          </div>
        </CardContent>
      ...
      <CardContent>
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          ...
          <div className="p-4 bg-purple-50 border border-purple-200 rounded-lg">
            ...
            <p className="text-2xl font-bold text-gray-900">$765,000</p>
          </div>
        </div>
      </CardContent>
    </Card>
...
export const renderTasks = () => (
  <div className="space-y-6">
    ...
    <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
      <Card>
        <CardContent className="p-6">
          <p className="text-sm text-gray-600 mb-2">Due Today</p>
          <p className="text-3xl font-bold text-gray-900">12</p>
        ...
        <div className="space-y-3">
          {[
            ...
            <div
              key={task.id}
              className={`p-4 border rounded-lg hover:bg-gray-50 cursor-pointer ${
                task.status === 'overdue' ? 'border-l-4 border-l-red-500 bg-red-50' : ''
              }`}
...
export const renderDocuments = () => (
  <div className="space-y-6">
    ...
    <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
      ...
      <Card>
        <CardContent className="p-6">
          <p className="text-sm text-gray-600 mb-2">Pending Signature</p>
          <p className="text-3xl font-bold text-amber-600">42</p>
          <p className="text-xs text-gray-500 mt-1">Awaiting parties</p>
        </CardContent>
      </Card>
      <Card>
        <CardContent className="p-6">
          <p className="text-sm text-gray-600 mb-2">Signed Today</p>
          <p className="text-3xl font-bold text-green-600">8</p>
          <p className="text-xs text-gray-500 mt-1">Via PEXA</p>
        </CardContent>
      </Card>
      <Card>
        <CardContent className="p-6">
          <p className="text-sm text-gray-600 mb-2">Version Conflicts</p>
          ...
          <table className="w-full">
            <thead className="bg-gray-50">
              <tr>
                ...
                <th className="px-6 py-3 text-center text-xs font-semibold text-gray-600 uppercase">Version</th>
                <th className="px-6 py-3 text-center text-xs font-semibold text-gray-600 uppercase">Status</th>
                <th className="px-6 py-3 text-left text-xs font-semibold text-gray-600 uppercase">PEXA Link</th>
            ...
            <tbody className="divide-y divide-gray-200">
              {[
                ...
                <tr key={idx} className="hover:bg-gray-50">
                  ...
                  <td className="px-6 py-4 font-mono text-xs text-gray-600">{doc.matter}</td>
                  <td className="px-6 py-4">
                    <span className="px-2 py-1 bg-blue-100 text-blue-700 text-xs font-semibold rounded">
                      {doc.category}
                    </span>
                  </td>
                  <td className="px-6 py-4 text-center text-sm text-gray-900">v{doc.version}</td>
                  <td className="px-6 py-4 text-center">
                    <span
                      className={`px-2 py-1 text-xs font-semibold rounded ${
                        doc.status === 'signed'
                  ...
                  <td className="px-6 py-4 text-sm text-gray-600">{doc.pexa}</td>
                  <td className="px-6 py-4 text-sm text-gray-600">{doc.updated}</td>
                  <td className="px-6 py-4 text-right">
      ...
      <CardContent>
        <div className="overflow-x-auto">
          <table className="w-full">
            <thead className="bg-gray-50">
              <tr>
                <th className="px-6 py-3 text-left text-xs font-semibold text-gray-600 uppercase">Condition ID</th>
            ...
            <tbody className="divide-y divide-gray-200">
              {[
                ...
                <tr key={idx} className="hover:bg-gray-50">
                  ...
                  <td className="px-6 py-4 font-mono text-xs text-gray-600">{condition.matter}</td>
  ...
  <div className="space-y-6">
    ...
    <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
      ...
      <Card>
        <CardContent className="p-6">
          <div className="flex items-center justify-between mb-2">
            <span className="text-sm text-gray-600">Field Drift</span>
            <AlertCircle className="w-5 h-5 text-red-600" />
          </div>
          <p className="text-3xl font-bold text-gray-900">5</p>
          <p className="text-xs text-gray-500 mt-1">Mismatches detected</p>
        </CardContent>
      </Card>
          ...
          <table className="w-full">
            <thead className="bg-gray-50">
              <tr>
                ...
                <th className="px-6 py-3 text-left text-xs font-semibold text-gray-600 uppercase">Property</th>
                <th className="px-6 py-3 text-center text-xs font-semibold text-gray-600 uppercase">Status</th>
                <th className="px-6 py-3 text-center text-xs font-semibold text-gray-600 uppercase">Participants</th>
            ...
            <tbody className="divide-y divide-gray-200">
              {[
                ...
                <tr key={idx} className="hover:bg-gray-50">
                  <td className="px-6 py-4 font-mono text-sm font-semibold text-purple-600">{ws.workspace}</td>
                  <td className="px-6 py-4 font-mono text-xs text-gray-600">{ws.matter}</td>
                  <td className="px-6 py-4 text-sm text-gray-900">{ws.property}</td>
                  <td className="px-6 py-4 text-center">
                    <span className={`px-2 py-1 text-xs font-semibold rounded ${
                      ws.status === 'active' ? 'bg-green-100 text-green-700' :
                      ws.status === 'drift_detected' ? 'bg-red-100 text-red-700' :
                      'bg-blue-100 text-blue-700'
                    }`}>
                      {ws.status.replace('_', ' ').toUpperCase()}
                    </span>
                  </td>
                  <td className="px-6 py-4 text-center text-sm text-gray-900">{ws.participants}</td>
                  <td className="px-6 py-4 text-sm text-gray-600">{ws.lastSync}</td>
                  <td className="px-6 py-4 text-right">
...
export const renderReports = () => (
  <div className="space-y-6">
    ...
    <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
      <Card>
        <CardContent className="p-6">
          <p className="text-sm text-gray-600 mb-2">Settlements (30d)</p>
      ...
      <Card>
        <CardContent className="p-6">
          <p className="text-sm text-gray-600 mb-2">Avg Cycle Time</p>
      ...
      <Card>
        <CardContent className="p-6">
          ...
          <p className="text-xs text-gray-500 mt-1">79 of 84</p>
        </CardContent>
      </Card>
      <Card>
        <CardContent className="p-6">
          ...
          <p className="text-xs text-gray-500 mt-1">Settled value</p>
        </CardContent>
      </Card>
    </div>
            ...
            {[
              ...
              <div key={idx} className="flex items-center justify-between p-4 border rounded-lg hover:bg-gray-50">
                <div className="flex-1">
                  ...
                  <p className="text-xs text-gray-500">{template.matters} matters • {template.stages} stages</p>
                </div>
                <div className="flex items-center gap-2">
                  <span className={`px-2 py-1 text-xs font-semibold rounded ${
        ...
        <CardContent>
          <div className="space-y-4">
            <div className="flex items-center justify-between p-3 border rounded-lg">
              <div>
                <p className="font-medium text-gray-900">Auto PEXA Sync</p>
                <p className="text-xs text-gray-500">Sync every 15 minutes</p>
              </div>
            ...
            <div className="flex items-center justify-between p-3 border rounded-lg">
              <div>
                ...
                <p className="text-xs text-gray-500">Task reminders and alerts</p>
              </div>
              <label className="relative inline-flex items-center cursor-pointer">
                <input type="checkbox" className="sr-only peer" defaultChecked />
                <div className="w-11 h-6 bg-gray-200 peer-focus:outline-none peer-focus:ring-4 peer-focus:ring-emerald-300 rounded-full peer peer-checked:after:translate-x-full peer-checked:after:border-white after:content-[''] after:absolute after:top-[2px] after:left-[2px] after:bg-white after:border-gray-300 after:border after:rounded-full after:h-5 after:w-5 after:transition-all peer-checked:bg-emerald-600"></div>
    ...
    <Card>
      ...
      <CardContent>
        <div className="space-y-6">
          ...
          <div>
            <label className="block text-sm font-medium text-gray-700 mb-2">PEXA Subscriber ID</label>
            <input
              type="text"
          ...
          <div>
            <label className="block text-sm font-medium text-gray-700 mb-2">Default Settlement Time</label>
            <select className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-emerald-500">
