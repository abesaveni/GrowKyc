...
const PROPERTY_PLACEHOLDER = '/images/property-placeholder.jpg';
...
export function PropertyCard({ 
  ...
  const [imgSrc, setImgSrc] = useState(caseData.property.imageUrl || PROPERTY_PLACEHOLDER);
  useEffect(() => {
    setImgSrc(caseData.property.imageUrl || PROPERTY_PLACEHOLDER);
  }, [caseData.property.imageUrl]);
    ...
    <Card className="overflow-hidden hover:shadow-lg transition-shadow duration-200">
      ...
      <div className="relative h-48 bg-white/10 overflow-hidden">
        <img
          ...
          onError={() => {
            if (imgSrc !== PROPERTY_PLACEHOLDER) setImgSrc(PROPERTY_PLACEHOLDER);
          }}
        />
