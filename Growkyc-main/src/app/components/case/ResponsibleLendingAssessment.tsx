    ...
    <div className="space-y-6">
      ...
      <div className="p-5 bg-gradient-to-br from-red-50 to-orange-50 border-2 border-red-400 rounded-lg">
        <div className="flex items-start gap-3">
          ...
          <div>
            <h4 className="font-bold text-red-300 text-base mb-2">⚖️ National Consumer Credit Protection Act 2009</h4>
            ...
            <div className="grid md:grid-cols-2 gap-3 text-xs">
              <div className="bg-white/60 p-3 rounded border border-red-300">
                <p className="font-bold text-red-300 mb-1">✓ Lender Must Hold:</p>
              ...
              <div className="bg-white/60 p-3 rounded border border-red-300">
                <p className="font-bold text-red-300 mb-1">✓ ASIC Compliance:</p>
                <ul className="space-y-1 text-red-300">
      ...
      <Card className="border-2 border-blue-300">
        ...
        <CardContent className="p-6 space-y-6">
          {/* Income Details */}
          <div>
            <h4 className="font-bold text-slate-100 mb-3">1. Income Verification</h4>
              ...
              <div>
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    className="w-full pl-10 pr-3 py-2 border border-white/10 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-600"
                    placeholder="8500"
                  />
                </div>
              </div>
            ...
            <div className="mt-4 p-4 bg-blue-500/10 border border-blue-500/30 rounded-lg">
              <p className="text-xs font-bold text-blue-300 mb-2">Required Verification Documents:</p>
                  ...
                  <>
                    <label className="flex items-center gap-2">
                      <input 
                        ...
                        className="w-4 h-4"
                      />
                      <span className="text-blue-300">Recent payslips (3 months)</span>
                    </label>
                    <label className="flex items-center gap-2">
                      <input 
                        type="checkbox"
                        ...
                        className="w-4 h-4"
                      />
                      <span className="text-blue-300">Employment letter</span>
                    </label>
                    <label className="flex items-center gap-2">
                      <input 
                        type="checkbox"
                        ...
                        className="w-4 h-4"
                      />
                      <span className="text-blue-300">Bank statements (3 months)</span>
                    </label>
                  </>
                )}
                  ...
                  <>
                    <label className="flex items-center gap-2">
                      <input 
                        ...
                        className="w-4 h-4"
                      />
                      <span className="text-blue-300">Tax returns (2 years)</span>
                    </label>
                    <label className="flex items-center gap-2">
                      <input 
                        type="checkbox"
                        ...
                        className="w-4 h-4"
                      />
                      <span className="text-blue-300">Notices of Assessment (2 years)</span>
                    </label>
                    <label className="flex items-center gap-2">
                      <input 
                        type="checkbox"
                        ...
                        className="w-4 h-4"
                      />
                      <span className="text-blue-300">Financial statements</span>
                    </label>
                    <label className="flex items-center gap-2">
                      <input 
                        type="checkbox"
                        ...
                        className="w-4 h-4"
                      />
                      <span className="text-blue-300">BAS statements</span>
                    </label>
                    <label className="flex items-center gap-2">
                      <input 
                        type="checkbox"
                        ...
                        className="w-4 h-4"
                      />
                      <span className="text-blue-300">Accountant letter</span>
                    </label>
                  </>
                )}
              </div>
          ...
          {/* Expenses */}
          <div>
            <h4 className="font-bold text-slate-100 mb-3">2. Living Expenses Verification</h4>
            <div className="grid md:grid-cols-2 gap-4">
              <div>
                <label className="block text-sm font-medium text-slate-300 mb-2">
          ...
          {/* Existing Debts */}
          <div>
            <h4 className="font-bold text-slate-100 mb-3">3. Existing Liabilities</h4>
            <div className="grid md:grid-cols-2 gap-4">
              <div>
                <label className="block text-sm font-medium text-slate-300 mb-2">
                ...
                <p className="text-xs text-slate-400 mt-1">Include: mortgages, car loans, credit cards, personal loans</p>
              </div>
              <div>
                <label className="flex items-center gap-2 mt-8">
                  <input 
                    ...
                    className="w-4 h-4"
                  />
                  <span className="text-sm font-medium text-slate-300">Credit report obtained & reviewed</span>
                </label>
              </div>
            </div>
          </div>
          ...
          {/* Loan Purpose */}
          <div>
            <h4 className="font-bold text-slate-100 mb-3">4. Loan Purpose & Objectives</h4>
      ...
      <Card className={`border-2 ${isUnsuitable ? 'border-red-400' : requiresEnhancedAssessment ? 'border-orange-400' : 'border-green-400'}`}>
        <CardHeader className={`bg-gradient-to-r ${isUnsuitable ? 'from-red-50 to-rose-50' : requiresEnhancedAssessment ? 'from-orange-50 to-yellow-50' : 'from-green-50 to-emerald-50'}`}>
          <CardTitle className="text-lg flex items-center gap-2">
            <Calculator className="w-5 h-5 text-slate-100" />
        ...
        <CardContent className="p-6 space-y-6">
          ...
          <div className="grid md:grid-cols-3 gap-4">
            {/* Monthly Surplus */}
            <div className={`p-4 rounded-lg border-2 ${monthlySurplus >= 0 ? 'bg-green-500/10 border-green-300' : 'bg-red-500/10 border-red-300'}`}>
              <div className="flex items-center gap-2 mb-2">
                ...
                <span className="font-bold text-sm text-slate-100">Monthly Surplus/Deficit</span>
              </div>
              <p className={`text-2xl font-bold ${monthlySurplus >= 0 ? 'text-green-300' : 'text-red-300'}`}>
            ...
            {/* Debt-to-Income */}
            <div className={`p-4 rounded-lg border-2 ${debtToIncome <= 40 ? 'bg-green-500/10 border-green-300' : debtToIncome <= 50 ? 'bg-orange-500/10 border-orange-300' : 'bg-red-500/10 border-red-300'}`}>
              <div className="flex items-center gap-2 mb-2">
                <DollarSign className="w-5 h-5 text-slate-300" />
                <span className="font-bold text-sm text-slate-100">Debt-to-Income Ratio</span>
              </div>
              <p className={`text-2xl font-bold ${debtToIncome <= 40 ? 'text-green-300' : debtToIncome <= 50 ? 'text-orange-300' : 'text-red-300'}`}>
            ...
            <div className="p-4 bg-blue-500/10 rounded-lg border-2 border-blue-300">
              <div className="flex items-center gap-2 mb-2">
                ...
                <span className="font-bold text-sm text-slate-100">Monthly Repayment</span>
              </div>
          ...
          <div className="p-4 bg-white/5 rounded-lg border border-white/10">
            <p className="font-bold text-sm text-slate-100 mb-3">Serviceability Calculation:</p>
            <div className="space-y-2 text-sm">
              <div className="flex justify-between">
                <span className="text-slate-300">Verified Monthly Income:</span>
                <span className="font-semibold text-green-300">+${monthlyIncome.toFixed(2)}</span>
              </div>
              <div className="flex justify-between">
                <span className="text-slate-300">Living Expenses:</span>
                <span className="font-semibold text-red-300">-${monthlyExpenses.toFixed(2)}</span>
              </div>
              <div className="flex justify-between">
                <span className="text-slate-300">Existing Debt Obligations:</span>
                <span className="font-semibold text-red-300">-${existingDebts.toFixed(2)}</span>
              </div>
              <div className="flex justify-between">
                <span className="text-slate-300">Proposed Loan Repayment:</span>
                <span className="font-semibold text-red-300">-${monthlyRepayment.toFixed(2)}</span>
              </div>
              <div className="pt-2 border-t-2 border-white/10 flex justify-between">
                <span className="font-bold text-slate-100">Net Monthly Position:</span>
                <span className={`font-bold text-lg ${monthlySurplus >= 0 ? 'text-green-300' : 'text-red-300'}`}>
                  ${monthlySurplus.toFixed(2)}
                </span>
              </div>
            </div>
          ...
          <div className={`p-5 rounded-lg border-2 ${isUnsuitable ? 'bg-red-500/10 border-red-400' : requiresEnhancedAssessment ? 'bg-orange-500/10 border-orange-400' : 'bg-green-500/10 border-green-400'}`}>
            <div className="flex items-start gap-3">
              {isUnsuitable ? (
              ...
              <div>
                <p className={`font-bold text-base mb-2 ${isUnsuitable ? 'text-red-300' : requiresEnhancedAssessment ? 'text-orange-300' : 'text-green-300'}`}>
                  {isUnsuitable ? '❌ LOAN APPEARS UNSUITABLE' : requiresEnhancedAssessment ? '⚠️ ENHANCED ASSESSMENT REQUIRED' : '✅ LOAN APPEARS SUITABLE'}
                </p>
                <p className={`text-sm mb-3 ${isUnsuitable ? 'text-red-300' : requiresEnhancedAssessment ? 'text-orange-300' : 'text-green-300'}`}>
                  {isUnsuitable 
                ...
                {isUnsuitable && (
                  <div className="bg-white/60 p-3 rounded border border-red-300 text-xs text-red-300">
