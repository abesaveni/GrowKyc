...
export function CaseVerificationReports({ caseData }: CaseVerificationReportsProps) {
  ...
  const getStatusIcon = (status: string) => {
    switch (status) {
      ...
      case 'review': return <AlertTriangle className="w-5 h-5 text-orange-600" />;
  ...
  const getStatusColor = (status: string) => {
    switch (status) {
      case 'passed': return 'bg-green-100 text-green-700 dark:bg-green-900 dark:text-green-300';
    ...
    <div className="space-y-6">
      ...
      <div className="bg-gradient-to-r from-[#0E7C9E] to-[#13B5EA] rounded-lg shadow-lg p-6 text-white">
        <div className="flex items-center justify-between">
          ...
          <Button className="bg-white text-[#0E7C9E] hover:bg-cyan-50">
      ...
      <div className="space-y-4">
        {filteredChecks.map(check => {
          ...
          return (
            <Card key={check.id} className="border-2 border-gray-200 dark:border-gray-700">
              {/* Check Header */}
              <div className="p-6">
                <div className="flex items-center justify-between">
                  <div className="flex items-center gap-4 flex-1">
                    ...
                    <div className="flex-1">
                      <div className="flex items-center gap-3 mb-1">
                        <h3 className="text-xl font-bold text-gray-900 dark:text-white">{check.name}</h3>
                        <span className={`px-3 py-1 rounded-full text-xs font-bold ${getStatusColor(check.status)}`}>
                          {check.status.toUpperCase()}
                        </span>
                        {check.score && (
                          <span className="px-3 py-1 bg-blue-100 text-blue-700 dark:bg-blue-900 dark:text-blue-300 rounded-full text-xs font-bold">
                            Score: {check.score}/100
                          </span>
                        )}
                      </div>
                      <p className="text-sm text-gray-600 dark:text-gray-400">{check.type}</p>
                ...
                <div className="border-t border-gray-200 dark:border-gray-700 p-6 bg-gray-50 dark:bg-gray-900 space-y-6">
                  ...
                  <div>
                    <div className="flex items-center gap-2 mb-3">
                      ...
                      <h4 className="font-bold text-gray-900 dark:text-white">AI Analysis Summary</h4>
                    </div>
                    ...
                    <div className="flex items-center gap-4 mt-3">
                      ...
                      <span className="px-3 py-1 bg-blue-50 text-blue-700 dark:bg-blue-900 dark:text-blue-300 rounded-lg font-semibold text-sm">
                  ...
                  {/* Key Findings */}
                  <div>
                    <h4 className="font-bold text-gray-900 dark:text-white mb-3">Key Findings</h4>
                  ...
                  {/* Recommendations */}
                  <div>
                    <h4 className="font-bold text-gray-900 dark:text-white mb-3">AI Recommendations</h4>
                    <div className="space-y-2">
