      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        <Card>
          ...
          <CardContent className="space-y-4">
            <div>
              <p className="text-sm text-gray-500">Case Created</p>
        ...
        <Card>
          ...
          <CardContent className="space-y-4">
            ...
            <div className="flex justify-between items-center">
              <span className="text-gray-600">LVR (Loan to Value)</span>
            ...
            <div className="flex justify-between items-center pt-4 border-t">
              <span className="text-gray-600">Equity Available</span>
                ...
                <div className="space-y-2">
                  ...
                  {caseData.borrowerDetails.pepStatus && (
                    <div className="bg-yellow-50 border border-yellow-200 rounded p-2 mt-2">
                      <p className="text-sm font-semibold text-yellow-800">⚠️ PEP Status Flagged</p>
                    </div>
                  )}
                </div>
              </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  {caseData.entityStructure.type === 'company' && (
                    <>
                      ...
                      <div>
                        <p className="text-sm text-gray-500">ACN / ABN</p>
                      ...
                      {caseData.entityStructure.directors && caseData.entityStructure.directors.length > 0 && (
                        <div className="col-span-2">
                          <p className="text-sm text-gray-500 mb-2">Directors ({caseData.entityStructure.directors.length})</p>
                  ...
                  {caseData.entityStructure.type === 'trust' && (
                    <>
                      <div>
                        <p className="text-sm text-gray-500">Trust Name</p>
                        <p className="font-medium">{caseData.entityStructure.trustName}</p>
                      </div>
                      <div>
                        <p className="text-sm text-gray-500">Trust Type</p>
                      ...
                      {caseData.entityStructure.trustees && caseData.entityStructure.trustees.length > 0 && (
                        <div className="col-span-2">
                          <p className="text-sm text-gray-500 mb-2">Trustees ({caseData.entityStructure.trustees.length})</p>
                          <div className="space-y-1">
          ...
          <CardContent>
            <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
              {caseData.property.titleReference && (
                <div>
                  <p className="text-sm text-gray-500">Title Reference</p>
                  <p className="font-medium">{caseData.property.titleReference}</p>
                </div>
              )}
              {caseData.property.lotNumber && (
                <div>
                  <p className="text-sm text-gray-500">Lot / Plan</p>
            ...
            {(caseData.property.floodRisk || caseData.property.bushfireRisk) && (
              <div className="mt-6 pt-6 border-t">
                <h3 className="font-semibold text-gray-900 mb-3">Environmental Risk</h3>
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
      ...
      {caseData.valuation?.rpDataAvmMid && (
        <Card>
          ...
          <CardContent>
            <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
              <div>
                <p className="text-sm text-gray-500">AVM Mid (Used)</p>
                <p className="font-medium text-lg text-green-600">${caseData.valuation.rpDataAvmMid.toLocaleString()}</p>
              </div>
              <div>
                <p className="text-sm text-gray-500">AVM Low</p>
                <p className="font-medium">${caseData.valuation.rpDataAvmLow?.toLocaleString()}</p>
              </div>
              <div>
                <p className="text-sm text-gray-500">AVM High</p>
            ...
            <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
              ...
              {caseData.loanDetails.missedPayments !== undefined && (
                <div>
                  ...
                  <p className="font-medium text-red-600">{caseData.loanDetails.missedPayments}</p>
                </div>
              )}
              ...
              {caseData.loanDetails.defaultReason && (
                <div className="col-span-4">
                  <p className="text-sm text-gray-500">Default Reason</p>
                  <p className="font-medium">{caseData.loanDetails.defaultReason}</p>
                </div>
              )}
              {caseData.loanDetails.hardshipCircumstances && (
                <div className="col-span-4">
                  <p className="text-sm text-gray-500">Hardship Circumstances</p>
          ...
          <CardContent>
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              ...
              {caseData.lenderDetails.aclNumber && (
                <>
                  <div>
                    <p className="text-sm text-gray-500">ACL Number</p>
                    <p className="font-medium">{caseData.lenderDetails.aclNumber}</p>
                  </div>
                  {caseData.lenderDetails.aclHolderName && (
                    <div>
                      <p className="text-sm text-gray-500">ACL Holder Name</p>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
              {caseData.allParties.borrowerLawyer && (
                <div className="border rounded-lg p-4">
                  <h4 className="font-semibold text-sm text-gray-700 mb-2">Borrower's Lawyer</h4>
                  <p className="font-medium">{caseData.allParties.borrowerLawyer.name}</p>
                  <p className="text-sm text-gray-600">{caseData.allParties.borrowerLawyer.firm}</p>
                  <p className="text-sm text-gray-600">{caseData.allParties.borrowerLawyer.email}</p>
                  <p className="text-sm text-gray-600">{caseData.allParties.borrowerLawyer.phone}</p>
                </div>
              )}
              {caseData.allParties.lenderLawyer && (
                <div className="border rounded-lg p-4">
                  <h4 className="font-semibold text-sm text-gray-700 mb-2">Lender's Lawyer</h4>
                  <p className="font-medium">{caseData.allParties.lenderLawyer.name}</p>
                  <p className="text-sm text-gray-600">{caseData.allParties.lenderLawyer.firm}</p>
                  <p className="text-sm text-gray-600">{caseData.allParties.lenderLawyer.email}</p>
                  <p className="text-sm text-gray-600">{caseData.allParties.lenderLawyer.phone}</p>
                </div>
              )}
              {caseData.allParties.realEstateAgent && (
                <div className="border rounded-lg p-4">
                  <h4 className="font-semibold text-sm text-gray-700 mb-2">Real Estate Agent</h4>
                  <p className="font-medium">{caseData.allParties.realEstateAgent.name}</p>
                  <p className="text-sm text-gray-600">{caseData.allParties.realEstateAgent.agency}</p>
                  <p className="text-sm text-gray-600">{caseData.allParties.realEstateAgent.email}</p>
                  <p className="text-sm text-gray-600">{caseData.allParties.realEstateAgent.phone}</p>
                  <p className="text-xs text-gray-500">Lic: {caseData.allParties.realEstateAgent.license}</p>
                </div>
              )}
              {caseData.allParties.accountant && (
                <div className="border rounded-lg p-4">
                  <h4 className="font-semibold text-sm text-gray-700 mb-2">Accountant</h4>
                  <p className="font-medium">{caseData.allParties.accountant.name}</p>
                  <p className="text-sm text-gray-600">{caseData.allParties.accountant.firm}</p>
                  <p className="text-sm text-gray-600">{caseData.allParties.accountant.email}</p>
                  <p className="text-sm text-gray-600">{caseData.allParties.accountant.phone}</p>
                </div>
              )}
              {caseData.allParties.valuer && (
                <div className="border rounded-lg p-4">
                  <h4 className="font-semibold text-sm text-gray-700 mb-2">Valuer</h4>
                  <p className="font-medium">{caseData.allParties.valuer.name}</p>
                  <p className="text-sm text-gray-600">{caseData.allParties.valuer.company}</p>
                  <p className="text-sm text-gray-600">{caseData.allParties.valuer.email}</p>
                  <p className="text-sm text-gray-600">{caseData.allParties.valuer.phone}</p>
                </div>
              )}
              {caseData.allParties.conveyancer && (
                <div className="border rounded-lg p-4">
                  <h4 className="font-semibold text-sm text-gray-700 mb-2">Conveyancer</h4>
                  <p className="font-medium">{caseData.allParties.conveyancer.name}</p>
                  <p className="text-sm text-gray-600">{caseData.allParties.conveyancer.firm}</p>
                  <p className="text-sm text-gray-600">{caseData.allParties.conveyancer.email}</p>
                  <p className="text-sm text-gray-600">{caseData.allParties.conveyancer.phone}</p>
                </div>
              )}
              {caseData.allParties.auctioneer && (
                <div className="border rounded-lg p-4">
                  <h4 className="font-semibold text-sm text-gray-700 mb-2">Auctioneer</h4>
                  <p className="font-medium">{caseData.allParties.auctioneer.name}</p>
                  <p className="text-sm text-gray-600">{caseData.allParties.auctioneer.company}</p>
                  <p className="text-sm text-gray-600">{caseData.allParties.auctioneer.email}</p>
                  <p className="text-sm text-gray-600">{caseData.allParties.auctioneer.phone}</p>
                </div>
              )}
              {caseData.allParties.propertyManager && (
                <div className="border rounded-lg p-4">
                  <h4 className="font-semibold text-sm text-gray-700 mb-2">Property Manager</h4>
                  <p className="font-medium">{caseData.allParties.propertyManager.name}</p>
                  <p className="text-sm text-gray-600">{caseData.allParties.propertyManager.agency}</p>
                  <p className="text-sm text-gray-600">{caseData.allParties.propertyManager.email}</p>
                  <p className="text-sm text-gray-600">{caseData.allParties.propertyManager.phone}</p>
                </div>
              )}
              {caseData.allParties.insuranceBroker && (
                <div className="border rounded-lg p-4">
                  <h4 className="font-semibold text-sm text-gray-700 mb-2">Insurance Broker</h4>
                  <p className="font-medium">{caseData.allParties.insuranceBroker.name}</p>
                  <p className="text-sm text-gray-600">{caseData.allParties.insuranceBroker.company}</p>
                  <p className="text-sm text-gray-600">{caseData.allParties.insuranceBroker.email}</p>
                  <p className="text-sm text-gray-600">{caseData.allParties.insuranceBroker.phone}</p>
                </div>
              )}
              {caseData.allParties.receiver?.appointed && (
                <div className="border rounded-lg p-4 border-orange-300 bg-orange-50">
                  <h4 className="font-semibold text-sm text-orange-700 mb-2">⚠️ Receiver/Liquidator</h4>
                  <p className="font-medium">{caseData.allParties.receiver.name}</p>
                  <p className="text-sm text-gray-600">{caseData.allParties.receiver.company}</p>
                  <p className="text-sm text-gray-600">{caseData.allParties.receiver.email}</p>
                  <p className="text-sm text-gray-600">{caseData.allParties.receiver.phone}</p>
                </div>
              )}
              {caseData.allParties.trustee?.appointed && (
                <div className="border rounded-lg p-4 border-purple-300 bg-purple-50">
                  <h4 className="font-semibold text-sm text-purple-700 mb-2">Trustee (Bankruptcy)</h4>
                  <p className="font-medium">{caseData.allParties.trustee.name}</p>
                  <p className="text-sm text-gray-600">{caseData.allParties.trustee.company}</p>
                  <p className="text-sm text-gray-600">{caseData.allParties.trustee.email}</p>
                </div>
              )}
            </div>
          </CardContent>
        ...
        {caseData.nccpCompliance && (
          <Card>
            ...
            <CardContent className="space-y-3">
              <div>
                <p className="text-sm text-gray-500">Subject to NCCP Act 2009</p>
                <p className="font-medium">
                  {caseData.nccpCompliance.subjectToNCCP ? (
                    <span className="text-orange-600 font-semibold">✓ Yes - Regulated Consumer Credit</span>
                  ) : (
                    <span className="text-green-600 font-semibold">✗ No - Not Consumer Credit</span>
                  )}
                </p>
              </div>
              ...
              {caseData.nccpCompliance.borrowerCooperation && (
                <div>
                  <p className="text-sm text-gray-500">Borrower Cooperation</p>
              ...
              {caseData.nccpCompliance.tenancyDetails && (
                <div>
                  <p className="text-sm text-gray-500">Tenancy Details</p>
