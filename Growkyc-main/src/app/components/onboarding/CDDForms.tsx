    ...
    <div className="space-y-6">
      ...
      <div className="border-l-4 border-blue-600 pl-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          ...
          <div>
            <label className="block text-sm font-semibold text-gray-700 mb-2">
              ACN <span className="text-red-600">*</span>
            </label>
            <input
              type="text"
              value={formData.acn || ''}
          ...
          <div>
            <label className="block text-sm font-semibold text-gray-700 mb-2">
              Date Incorporated <span className="text-red-600">*</span>
            </label>
            <input
              type="date"
          ...
          <div className="md:col-span-2">
            <label className="block text-sm font-semibold text-gray-700 mb-2">
              Registered Office <span className="text-red-600">*</span>
            </label>
            <input
              type="text"
        ...
        <div className="flex items-center justify-between mb-4">
          <div>
            <h4 className="font-bold text-gray-900">
              Beneficial Owners (25%+ ownership) <span className="text-red-600">*</span>
            </h4>
            <p className="text-sm text-gray-600">List all individuals who own 25% or more, or CEO if none</p>
          </div>
          <button
        ...
        {formData.beneficialOwners && formData.beneficialOwners.length > 0 ? (
          <div className="space-y-4">
            {formData.beneficialOwners.map((owner: any, index: number) => (
              <div key={owner.id} className="border-2 border-gray-200 rounded-lg p-4">
                <div className="flex items-center justify-between mb-4">
                  <h5 className="font-semibold text-gray-900">Beneficial Owner #{index + 1}</h5>
                  <button
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  ...
                  <div className="md:col-span-2">
                    <label className="flex items-start gap-3 p-3 border border-gray-200 rounded hover:bg-gray-50">
                      ...
                      />
                      <div>
                        <span className="text-sm font-semibold text-gray-900">PEP Status</span>
                        <p className="text-xs text-gray-600">Is this person a Politically Exposed Person?</p>
                      </div>
                    </label>
                  </div>
                </div>
          ...
          <div className="text-center py-8 bg-gray-50 rounded-lg border-2 border-dashed border-gray-300">
            <p className="text-gray-600 mb-2">No beneficial owners added</p>
            <p className="text-sm text-gray-500">Click "Add Owner" to add beneficial owners</p>
          </div>
        )}
      </div>
      ...
      <div className="border-l-4 border-red-600 pl-4">
        <h4 className="font-bold text-gray-900 mb-4">Risk Questions</h4>
        <div className="space-y-3">
          <label className="flex items-start gap-3 p-3 border border-gray-200 rounded hover:bg-gray-50">
            <input
              ...
              className="mt-1 w-4 h-4"
            />
            <span className="text-sm text-gray-900">Significant cash transactions</span>
          </label>
          <label className="flex items-start gap-3 p-3 border border-gray-200 rounded hover:bg-gray-50">
            <input
              type="checkbox"
              ...
              className="mt-1 w-4 h-4"
            />
            <span className="text-sm text-gray-900">Cryptocurrency involvement</span>
          </label>
          <label className="flex items-start gap-3 p-3 border border-gray-200 rounded hover:bg-gray-50">
            <input
              type="checkbox"
              ...
              className="mt-1 w-4 h-4"
            />
            <span className="text-sm text-gray-900">Complex ownership structure</span>
          </label>
          <label className="flex items-start gap-3 p-3 border border-gray-200 rounded hover:bg-gray-50">
            <input
              type="checkbox"
              ...
              className="mt-1 w-4 h-4"
            />
            <span className="text-sm text-gray-900">Cross-border operations</span>
          </label>
          <label className="flex items-start gap-3 p-3 border border-gray-200 rounded hover:bg-gray-50">
            <input
              type="checkbox"
              ...
              className="mt-1 w-4 h-4"
            />
            <span className="text-sm text-gray-900">Links to high risk countries</span>
          </label>
        </div>
      </div>
      ...
      <div className="border-l-4 border-indigo-600 pl-4">
        ...
        <div className="space-y-4">
          <div>
            <label className="block text-sm font-semibold text-gray-700 mb-2">ASIC Extract</label>
            <input
              type="file"
              accept=".pdf"
              onChange={(e) => {
          ...
          <div>
            <label className="block text-sm font-semibold text-gray-700 mb-2">Constitution</label>
            <input
              type="file"
              accept=".pdf"
              onChange={(e) => {
          ...
          <div>
            <label className="block text-sm font-semibold text-gray-700 mb-2">Share Register</label>
            <input
              type="file"
              accept=".pdf"
              onChange={(e) => {
