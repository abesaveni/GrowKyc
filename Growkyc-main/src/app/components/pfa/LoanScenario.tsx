    ...
    return (
      <div className="max-w-4xl mx-auto p-8">
        <div className="bg-gradient-to-br from-green-50 to-blue-50 border-2 border-green-300 rounded-lg p-8 text-center">
          ...
          <h2 className="text-3xl font-bold text-slate-100 mb-2">Scenario Submitted!</h2>
          ...
          <div className="bg-white rounded-lg p-6 mb-6 text-left">
            <h3 className="font-bold text-slate-100 mb-4">Submission Summary</h3>
            <div className="grid grid-cols-2 gap-4">
              ...
              <div>
                ...
                <p className="font-semibold text-slate-100">{formData.borrowerName}</p>
              </div>
              <div>
                <p className="text-sm text-slate-300">Loan Amount</p>
                <p className="font-semibold text-slate-100">${formData.loanAmount.toLocaleString()}</p>
              </div>
              <div>
                <p className="text-sm text-slate-300">LVR</p>
                <p className="font-semibold text-slate-100">{formData.lvrCompletion}%</p>
              </div>
            </div>
          </div>
          <div className="flex gap-4 justify-center">
            ...
            <button
              ...
              className="px-6 py-3 bg-white/10 text-slate-300 rounded-lg hover:bg-gray-300 transition-colors font-semibold"
            >
              Print Summary
            </button>
          </div>
  ...
  return (
    <div className="min-h-screen bg-white/5 p-6">
      <div className="max-w-6xl mx-auto">
            ...
            {[1, 2, 3, 4].slice(0, getTotalSteps()).map((step) => (
              <div key={step} className="flex items-center flex-1">
                <div className="flex flex-col items-center flex-1">
                  ...
                  <p className={`text-xs mt-2 font-semibold ${step === currentStep ? 'text-blue-400' : 'text-slate-300'}`}>
                    Step {step}
                  </p>
                </div>
                {step < getTotalSteps() && (
                  <div className={`h-1 flex-1 mx-2 ${step < currentStep ? 'bg-green-500' : 'bg-white/10'}`} />
                )}
              </div>
            ))}
          </div>
          <h2 className="text-xl font-bold text-slate-100 text-center">{getStepTitle()}</h2>
        </div>

        {/* Step 1: Loan Type Selection */}
        {currentStep === 1 && (
          <div className="bg-white rounded-lg p-6">
            <h3 className="text-lg font-bold text-slate-100 mb-4">Select Loan Type</h3>
            <p className="text-slate-300 mb-6">Choose the type of loan scenario you're submitting</p>
                  ...
                  <button
                    ...
                    className={`p-6 rounded-lg border-2 transition-all ${
                      isSelected
                        ...
                        : 'border-white/10 hover:border-blue-300 bg-white'
                    }`}
                  >
                    ...
                    <h4 className="font-bold text-slate-100 mb-1">{type.label}</h4>
                    {isSelected && (
                      <CheckCircle className="w-5 h-5 text-blue-400 mt-2" />
                    )}
                  </button>
                );
              })}
        ...
        {currentStep === 2 && (
          <div className="bg-white rounded-lg p-6">
            <h3 className="text-lg font-bold text-slate-100 mb-6">Borrower & Security Information</h3>
        ...
        {currentStep === 4 && (
          <div className="bg-white rounded-lg p-6">
            <h3 className="text-lg font-bold text-slate-100 mb-6">Exit Strategy & Risk Assessment</h3>
            ...
            <div className="space-y-6">
              ...
              <div className="bg-gradient-to-br from-blue-50 to-purple-50 border-2 border-blue-300 rounded-lg p-6">
                <h4 className="font-bold text-blue-300 mb-4">Scenario Summary</h4>
                <div className="grid grid-cols-2 md:grid-cols-3 gap-4">
                  ...
                  <div>
                    <p className="text-sm text-slate-300">Borrower</p>
                    <p className="font-bold text-slate-100">{formData.borrowerName}</p>
                  </div>
                  <div>
                    <p className="text-sm text-slate-300">Loan Amount</p>
                    <p className="font-bold text-slate-100">${formData.loanAmount.toLocaleString()}</p>
                  </div>
                  <div>
                    <p className="text-sm text-slate-300">LVR</p>
                    <p className="font-bold text-slate-100">{formData.lvrCompletion}%</p>
                  </div>
                  <div>
                    <p className="text-sm text-slate-300">Term</p>
                    <p className="font-bold text-slate-100">{formData.loanTerm} months</p>
                  </div>
                  <div>
                    <p className="text-sm text-slate-300">Brokerage</p>
                    <p className="font-bold text-slate-100">{formData.brokerage}%</p>
                  </div>
                </div>
              </div>
            </div>
