...
export function BorrowerPortal() {
  ...
  const renderWelcome = () => (
    <div className="space-y-6">
      ...
      <div className="bg-white border border-gray-300 rounded-lg p-6">
        ...
        <div className="grid grid-cols-2 gap-4">
          ...
          <div>
            ...
            <p className="font-semibold text-gray-900">${application.loanAmount.toLocaleString()}</p>
          </div>
          <div>
      ...
      {/* Your Broker */}
      <div className="bg-white border border-gray-300 rounded-lg p-6">
        <h2 className="text-xl font-semibold text-gray-900 mb-4">Your Broker</h2>
        <div className="flex items-center gap-4">
          <div className="w-16 h-16 bg-blue-100 rounded-full flex items-center justify-center">
            <User className="w-8 h-8 text-blue-600" />
          </div>
          <div className="flex-1">
            <p className="font-semibold text-gray-900">{application.broker.name}</p>
            <p className="text-sm text-gray-600">{application.broker.company}</p>
            <div className="flex items-center gap-4 mt-2">
              <a href={`tel:${application.broker.phone}`} className="text-sm text-blue-600 hover:underline flex items-center gap-1">
                <Phone className="w-4 h-4" />
                {application.broker.phone}
              </a>
              <a href={`mailto:${application.broker.email}`} className="text-sm text-blue-600 hover:underline flex items-center gap-1">
      ...
      {/* What's Next */}
      <div className="bg-white border border-gray-300 rounded-lg p-6">
        <h2 className="text-xl font-semibold text-gray-900 mb-4">What You Need to Complete</h2>
        <div className="space-y-3">
          <div className="flex items-start gap-3">
            <CheckCircle className="w-5 h-5 text-green-600 mt-0.5" />
            <div>
              <p className="font-medium text-gray-900">Verify Company Details</p>
              <p className="text-sm text-gray-600">Confirm your company information is correct</p>
            </div>
          </div>
          <div className="flex items-start gap-3">
            <CheckCircle className="w-5 h-5 text-green-600 mt-0.5" />
            <div>
              <p className="font-medium text-gray-900">Director Information</p>
              <p className="text-sm text-gray-600">Provide details for all directors and guarantors</p>
            </div>
          </div>
          <div className="flex items-start gap-3">
            <CheckCircle className="w-5 h-5 text-green-600 mt-0.5" />
            <div>
              ...
              <p className="text-sm text-gray-600">Upload ID documents for KYC compliance</p>
            </div>
          </div>
          <div className="flex items-start gap-3">
            <CheckCircle className="w-5 h-5 text-green-600 mt-0.5" />
            <div>
              ...
              <p className="text-sm text-gray-600">Financial statements, bank statements, and other required documents</p>
            </div>
          </div>
          <div className="flex items-start gap-3">
            <CheckCircle className="w-5 h-5 text-green-600 mt-0.5" />
            <div>
              <p className="font-medium text-gray-900">Sign Declarations</p>
              <p className="text-sm text-gray-600">Review and accept terms and declarations</p>
            </div>
          </div>
        </div>
      </div>
  ...
  const renderCompanyDetails = () => (
    <div className="space-y-6">
      <div className="bg-white border border-gray-300 rounded-lg p-6">
        ...
        <p className="text-gray-600 mb-6">Please verify and update your company information</p>
        ...
        <div className="space-y-4">
          ...
          <div>
            <label className="block text-sm font-medium text-gray-700 mb-2">Trading Address (if different)</label>
            <input
              type="text"
              placeholder="Street Address"
              className="w-full px-4 py-2 border border-gray-300 rounded-lg mb-2"
            />
            <div className="grid grid-cols-3 gap-2">
              <input type="text" placeholder="Suburb" className="px-4 py-2 border border-gray-300 rounded-lg" />
              <input type="text" placeholder="State" className="px-4 py-2 border border-gray-300 rounded-lg" />
              <input type="text" placeholder="Postcode" className="px-4 py-2 border border-gray-300 rounded-lg" />
            </div>
          </div>
  ...
  const renderDirectors = () => (
    <div className="space-y-6">
      <div className="bg-white border border-gray-300 rounded-lg p-6">
        <h2 className="text-xl font-semibold text-gray-900 mb-4">Directors & Guarantors</h2>
        <p className="text-gray-600 mb-6">Provide details for all directors and guarantors</p>

        {/* Director 1 */}
        <div className="mb-8 pb-8 border-b">
          <h3 className="text-lg font-semibold text-gray-900 mb-4">Director 1</h3>
          <div className="space-y-4">
            <div className="grid grid-cols-2 gap-4">
              <div>
            ...
            <div>
              <label className="flex items-center gap-2">
                ...
                <span className="text-sm text-gray-700">Acting as personal guarantor</span>
              </label>
            </div>
          </div>
        </div>
        ...
        {/* Director 2 */}
        <div className="mb-6">
          <h3 className="text-lg font-semibold text-gray-900 mb-4">Director 2</h3>
          <div className="space-y-4">
            <div className="grid grid-cols-2 gap-4">
              <div>
                <label className="block text-sm font-medium text-gray-700 mb-2">First Name *</label>
  ...
  const renderKYC = () => (
    <div className="space-y-6">
      <div className="bg-white border border-gray-300 rounded-lg p-6">
        <h2 className="text-xl font-semibold text-gray-900 mb-4">KYC & Identity Verification</h2>
        ...
        {/* Director 1 KYC */}
        <div className="mb-8 pb-8 border-b">
          <h3 className="text-lg font-semibold text-gray-900 mb-4">John Smith - Director 1</h3>
          
          <div className="space-y-4">
            <div>
              <label className="block text-sm font-medium text-gray-700 mb-2">Primary ID (70 points) *</label>
              ...
              <div className="border-2 border-dashed border-gray-300 rounded-lg p-6 text-center">
                ...
                <p className="text-sm text-gray-600 mb-2">Upload certified copy of ID</p>
                <Button variant="outline" size="sm">
                  Choose File
                </Button>
            ...
            <div>
              <label className="block text-sm font-medium text-gray-700 mb-2">Secondary ID (30 points minimum) *</label>
              <select className="w-full px-4 py-2 border border-gray-300 rounded-lg mb-3">
                <option>Select ID type...</option>
              ...
              <div className="border-2 border-dashed border-gray-300 rounded-lg p-6 text-center">
                <Upload className="w-8 h-8 text-gray-400 mx-auto mb-2" />
                <p className="text-sm text-gray-600 mb-2">Upload secondary ID</p>
                <Button variant="outline" size="sm">
                  Choose File
                </Button>
              </div>
            ...
            <div className="mt-6 p-4 bg-gray-50 rounded-lg">
              <h4 className="font-medium text-gray-900 mb-3">Additional Verification Questions</h4>
        ...
        {/* Director 2 KYC */}
        <div className="mb-6">
          <h3 className="text-lg font-semibold text-gray-900 mb-4">Jane Doe - Director 2</h3>
  ...
  const renderDocuments = () => (
    <div className="space-y-6">
      <div className="bg-white border border-gray-300 rounded-lg p-6">
        ...
        <p className="text-gray-600 mb-6">Upload all required documents for your application</p>
        ...
        <div className="space-y-4">
          ...
          <div className="p-4 border border-gray-300 rounded-lg">
            <div className="flex items-start justify-between mb-3">
              <div>
                <h4 className="font-semibold text-gray-900">Financial Statements (Last 2 years) *</h4>
                <p className="text-sm text-gray-600">Profit & Loss, Balance Sheet</p>
              </div>
            ...
            <div className="border-2 border-dashed border-gray-300 rounded-lg p-6 text-center">
              ...
              <p className="text-xs text-gray-500 mt-2">PDF, JPG or PNG • Max 10MB per file</p>
            </div>
          </div>
          ...
          <div className="p-4 border border-gray-300 rounded-lg">
            <div className="flex items-start justify-between mb-3">
              <div>
                <h4 className="font-semibold text-gray-900">Bank Statements (Last 6 months) *</h4>
                <p className="text-sm text-gray-600">All business bank accounts</p>
              </div>
              <span className="px-2 py-1 bg-red-100 text-red-700 text-xs font-medium rounded">
                Required
              </span>
          ...
          <div className="p-4 border border-gray-300 rounded-lg">
            <div className="flex items-start justify-between mb-3">
              <div>
                <h4 className="font-semibold text-gray-900">Tax Returns (Last 2 years) *</h4>
                <p className="text-sm text-gray-600">Company tax returns with ATO lodgement receipt</p>
              </div>
              <span className="px-2 py-1 bg-red-100 text-red-700 text-xs font-medium rounded">
                Required
              </span>
          ...
          <div className="p-4 border border-gray-300 rounded-lg">
            <div className="flex items-start justify-between mb-3">
              <div>
                <h4 className="font-semibold text-gray-900">ASIC Company Extract *</h4>
                <p className="text-sm text-gray-600">Current company extract (less than 30 days old)</p>
              </div>
              <span className="px-2 py-1 bg-red-100 text-red-700 text-xs font-medium rounded">
                Required
              </span>
          ...
          <div className="p-4 border border-gray-300 rounded-lg">
            <div className="flex items-start justify-between mb-3">
              <div>
                ...
                <p className="text-sm text-gray-600">Contract of Sale, Section 32, Title Search</p>
              </div>
              <span className="px-2 py-1 bg-red-100 text-red-700 text-xs font-medium rounded">
                Required
              </span>
          ...
          <div className="p-4 border border-gray-300 rounded-lg">
            <div className="flex items-start justify-between mb-3">
              <div>
                <h4 className="font-semibold text-gray-900">Property Valuation</h4>
                <p className="text-sm text-gray-600">If available (otherwise we will arrange)</p>
              </div>
          ...
          <div className="p-4 border border-gray-300 rounded-lg">
            <div className="flex items-start justify-between mb-3">
              <div>
                ...
                <p className="text-sm text-gray-600">Any additional documents to support your application</p>
              </div>
              <span className="px-2 py-1 bg-gray-100 text-gray-700 text-xs font-medium rounded">
                Optional
              </span>
  ...
  const renderDeclarations = () => (
    <div className="space-y-6">
      <div className="bg-white border border-gray-300 rounded-lg p-6">
        <h2 className="text-xl font-semibold text-gray-900 mb-4">Declarations & Consent</h2>
        <p className="text-gray-600 mb-6">Please read and accept the following declarations</p>

        <div className="space-y-6">
          {/* Privacy Consent */}
          <div className="p-4 border border-gray-300 rounded-lg">
            <h3 className="font-semibold text-gray-900 mb-3">Privacy & Credit Consent</h3>
            <div className="bg-gray-50 p-4 rounded max-h-60 overflow-y-auto text-sm text-gray-700 mb-4">
              <p className="mb-3">
          ...
          <div className="p-4 border border-gray-300 rounded-lg">
            <h3 className="font-semibold text-gray-900 mb-3">Information Accuracy Declaration</h3>
          ...
          {/* Financial Position */}
          <div className="p-4 border border-gray-300 rounded-lg">
            <h3 className="font-semibold text-gray-900 mb-3">Financial Position Declaration</h3>
            <div className="bg-gray-50 p-4 rounded text-sm text-gray-700 mb-4">
              <p>
                I/We declare that:
              </p>
          ...
          <div className="p-4 border border-gray-300 rounded-lg">
            <h3 className="font-semibold text-gray-900 mb-3">Electronic Signature</h3>
            ...
            <div className="space-y-4">
              <div>
                <label className="block text-sm font-medium text-gray-700 mb-2">Full Name (Director 1) *</label>
                <input
                  type="text"
              ...
              <div>
                <label className="block text-sm font-medium text-gray-700 mb-2">Full Name (Director 2) *</label>
                <input
                  type="text"
        ...
        <div className="max-w-7xl mx-auto px-6 py-4">
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-3">
              ...
              <div>
                <h1 className="text-lg font-bold text-gray-900">PFA Borrower Portal</h1>
                <p className="text-xs text-gray-600">Secure Application Portal</p>
              </div>
            </div>
